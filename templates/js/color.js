	...
	for (j = 0; j < 6 + 1; j++)
	{
    	for (i = 0; i < pas + 1; i++)
		{
			...
			b = Math.floor(col[j][4] + col[j][5] * i * (255) / pas);
  			...
  			codehex = r + '' + g + '' + b;
  			document.write('<tr><td align=\"right\" bgColor=\"' + RGB2Hexa(r,g,b) + '\" onClick=\"insertTag(this.bgColor);lightCase(this);\" title=\"' + RGB2Hexa(r,g,b) + '\" width=\"15\" height=\"1\"><img height=\"1\" src="images/spacer.gif" width=\"15\" /></td></tr>\n');
		}
	}
}
