...
modified for "flying ghosts" by Zifnab - http://www.zifnab.de */

  num=2; //Smoothness depends on image file size, the smaller the size the more you can use!
  ...
  //Pre-load images!
  picsl=new Array("images/effects/ghost1l.gif","images/effects/ghost2l.gif");
  picsr=new Array("images/effects/ghost1r.gif","images/effects/ghost2r.gif");
  loadl=new Array();
  loadr=new Array();
