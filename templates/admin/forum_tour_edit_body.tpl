...
<table align="center" cellpadding="4" cellspacing="1" width="100%" class="forumline"><form action="{S_POST_ACTION}" method="post" name="post">
<tr>
	<th class="thHead" colspan="2">{L_MODE}</th>
</tr>
<tr>
	<td class="row1" width="22%"><b>{L_SUBJECT}:</b></td>
	<td class="row2" width="78%"><input type="text" name="subject" size="35" maxlength="60" style="width:400px" tabindex="2" class="post" value="{SUBJECT}" /></td>
</tr>
<tr>
	...
	<td class="row2" valign="top"><table width="300" cellspacing="0" cellpadding="2">
	<tr align="center" valign="middle"> 
		...
		<tr align="center" valign="middle"> 
			...
			<td align="center" colspan="2"><select name="addbbcodefontcolor" onChange="bbfontstyle('[color=' + this.form.addbbcodefontcolor.options[this.form.addbbcodefontcolor.selectedIndex].value + ']', '[/color]');this.selectedIndex=0;" onMouseOver="helpline('s')">
		...
		<tr> 
			<td colspan="2" align="center"><select name="addbbcodefontsize" onChange="bbfontstyle('[size=' + this.form.addbbcodefontsize.options[this.form.addbbcodefontsize.selectedIndex].value + ']', '[/size]');this.selectedIndex=0;" onMouseOver="helpline('f')">
			...
			<td colspan="3" align="center"><select name="addbbcodefontface" onchange="bbfontstyle('[font=' + this.form.addbbcodefontface.options[this.form.addbbcodefontface.selectedIndex].value + ']', '[/font]');this.selectedIndex=0;" onmouseover="helpline('f1')">
		...
		<tr> 
			<td colspan="5" align="center" class="gensmall"><a href="javascript:toggleBlock('bbcode');" onMouseOver="helpline('a1')" class="gensmall">{L_EXPAND_BBCODE}</a> &bull; <a href="javascript:bbstyle(-1)" class="gensmall" onMouseOver="helpline('a')">{L_BBCODE_CLOSE_TAGS}</a> &bull; <a href="{FORUM_LIST}" class="gensmall">{L_INDEX}</a></td>
		</tr>
		</table>
		...
		<table width="100%" cellspacing="2" cellpadding="2">
		  <tr> 
			<td colspan="5" align="center"><select name="addbbcodetextalign" onChange="bbfontstyle('[align=' + this.form.addbbcodetextalign.options[this.form.addbbcodetextalign.selectedIndex].value + ']', '[/align]')" onMouseOver="helpline('c')">
		...
		<tr> 
			<td colspan="5" align="center"><select name="addbbcodeshadowcolor" onChange="bbfontstyle('[shadow=' + this.form.addbbcodeshadowcolor.options[this.form.addbbcodeshadowcolor.selectedIndex].value + ']', '[/shadow]')" onMouseOver="helpline('s1')">
		...
		<tr>
			<td class="gensmall"><input type="text" name="helpbox" size="35" class="helpline" style="width:400px; font-size:10px" value="{L_STYLES_TIP}" /></td>
		</tr>
		<tr>
			<td align="left"><table width="100%">
			<tr> 
				<td valign="top"><textarea name="message" rows="16" cols="35" wrap="virtual" style="width:400px" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea></td>
...
<tr>
	<td class="row1"><b class="gen">{L_ACCESS}:</b></td>
	<td class="row2">{PAGE_ACCESS}</td>
</tr>
<tr>
	<td class="catBottom" colspan="2" align="center"><input type="hidden" name="bbcode_uid" value="{BBCODE_UID}"><input tabindex="5" type="submit" name="submit" class="mainoption" value="{L_SUBMIT}" />&nbsp;&nbsp;<input tabindex="6" type="submit" name="cancel" class="liteoption" value="{L_CLOSE}" /></td>
</tr>
</form></table>
<br />
