...
<!-- BEGIN modules -->
	<tr>
		<td class="catHead" colspan="4" align="center"><span class="cattitle">{modules.MODULE_NAME}</span></th>
	</tr>
	<tr> 
	  <th class="thCornerL">&nbsp;{L_LANGUAGE_KEY}&nbsp;</th>
	  <th class="thtop">&nbsp;{L_LANGUAGE_VALUE}&nbsp;</th>
	  <th class="thTop">&nbsp;{L_UPDATE}&nbsp;</th>
