...
<table width="100%" align="center" cellpadding="4" cellspacing="1" class="forumline"><form method="post" name="attach_list" action="{S_MODE_ACTION}">
<tr> 
	<td class="catHead" colspan="8" align="center"><span class="genmed">{L_VIEW}:&nbsp;{S_VIEW_SELECT}&nbsp;&nbsp;{L_SELECT_SORT_METHOD}:&nbsp;{S_MODE_SELECT}&nbsp;&nbsp;{L_ORDER}:&nbsp;{S_ORDER_SELECT}&nbsp;&nbsp; <input type="submit" name="submit" value="{L_SUBMIT}" class="liteoption" /></span></td>
</tr>
<tr> 
	<th class="thCornerL">#</th>
	<th class="thTop">{L_FILENAME} / {L_FILECOMMENT}</th>
...
<tr> 
	...
	<td class="{attachrow.ROW_CLASS}" align="center"><span class="gen"><a href="{attachrow.U_VIEW_ATTACHMENT}" class="gen" target="_blank">{attachrow.FILENAME}</a><br /><input type="text" size="40" maxlength="200" name="attach_comment_list[]" value="{attachrow.COMMENT}" class="post" /></span></td>
...
<!-- END attachrow -->
<tr> 
	<td class="catBottom" colspan="8" align="right"><input type="submit" name="submit_change" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="submit" name="delete" value="{L_DELETE}" class="liteoption" /></td>
</tr>
</table>
...
<tr> 
	<td align="right" colspan="2"><b class="gensmall"><a href="javascript:select_switch(true);" class="gensmall">{L_MARK_ALL}</a> :: <a href="javascript:select_switch(false);" class="gensmall">{L_UNMARK_ALL}</a></b></td>
</tr>
<tr> 
