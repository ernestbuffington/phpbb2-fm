...
<table cellpadding="4" cellspacing="1" width="100%" align="center">
  ...
  <tr> 
	...
	<td class="row2"><a href="{U_TABLECOUNT}" class="genmed">{L_TABLES}</a>:</td>
  ...
  <tr> 
	<td class="row2"><a href="{U_NUMBER_ATTACHMENTS}" class="genmed">{L_NUMBER_ATTACHMENTS}</a>:</td>
	<td class="row1"><b>{NUMBER_OF_ATTACHMENTS}</b></td>
	<td class="row2">{L_ATTACHMENTS_PER_DAY}:</td>
	<td class="row1"><b>{ATTACHMENTS_PER_DAY}</b></td>
  </tr>
  <tr> 
	<td class="row2"><a href="{U_NUMBER_USERS}" class="genmed">{L_NUMBER_USERS}</a>:</td>
  ...
  <tr> 
	<td class="row2"><a href="{U_NUMBER_PVT}" class="genmed">{L_NUMBER_PVT}</a>:</td>
  ...
  <tr> 
	<td class="row2"><a href="{U_NUMBER_DATA_DISABLE}" class="genmed">{L_NUMBER_DATA_DISABLE}</a>:</td>
  ...
  <tr>
	<td class="row2">{L_NUMBER_ADMINISTRATORS}:</td>
        <td class="row1" colspan="3"><b>{NUMBER_OF_ADMINISTRATORS}</b> <span class="gensmall">{NAMES_OF_ADMINISTRATORS}</span></td>
  </tr>
  <tr>
	<td class="row2">{L_NUMBER_LESS_ADMIN}:</td>
        <td class="row1" colspan="3"><b>{NUMBER_OF_LESS_ADMIN}</b> <span class="gensmall">{NAMES_OF_LESS_ADMIN}</span></td>
  </tr>
  <tr>
    	<td class="row2">{L_NUMBER_MODERATORS}:</td>
    	<td class="row1" colspan="3"><b>{NUMBER_OF_MODERATORS}</b> <span class="gensmall">{NAMES_OF_MODERATORS}</span></td>
  </tr>
  <tr>
	<td class="row2">{L_NUMBER_DEACTIVATED_USERS}:</td>
	<td class="row1" colspan="3"><b>{NUMBER_OF_DEACTIVATED_USERS}</b> <span class="gensmall">{NAMES_OF_DEACTIVATED}</span></td>
  </tr>
</table>
<br />
...
<tr>
 ...
 <tr> 
  ...
  <tr> 
	...
	<td class="{reg_user_row.ROW_CLASS}">&nbsp;<a href="{reg_user_row.U_WHOIS_IP}" class="genmed" target="_blank">{reg_user_row.IP_ADDRESS}</a>&nbsp;</td>
  </tr>
  <!-- END reg_user_row -->
  <tr> 
  ...
  <tr> 
	<td class="{spider_user_row.ROW_CLASS}">&nbsp;<span class="genmed">{spider_user_row.USERNAME}</span>&nbsp;</td>
	<td align="center" class="{spider_user_row.ROW_CLASS}">&nbsp;<span class="genmed">{spider_user_row.STARTED}</span>&nbsp;</td>
	<td align="center" nowrap="nowrap" class="{spider_user_row.ROW_CLASS}">&nbsp;<span class="genmed">{spider_user_row.LASTUPDATE}</span>&nbsp;</td>
	<td class="{spider_user_row.ROW_CLASS}">&nbsp;<a href="{spider_user_row.U_FORUM_LOCATION}" class="genmed">{spider_user_row.FORUM_LOCATION}</a>&nbsp;</td>
	<td class="{spider_user_row.ROW_CLASS}">&nbsp;<a href="{spider_user_row.U_WHOIS_IP}" class="genmed" target="_blank">{spider_user_row.IP_ADDRESS}</a>&nbsp;</td>
  </tr>
  <!-- END spider_user_row -->
  <tr> 
	<td colspan="5" height="1" class="row3"><img src="../images/spacer.gif" width="1" height="1" alt="" title="" /></td>
  ...
  <tr> 
	...
	<td class="{guest_user_row.ROW_CLASS}" nowrap="nowrap">&nbsp;<a href="{guest_user_row.U_WHOIS_IP}" class="genmed" target="_blank">{guest_user_row.IP_ADDRESS}</a> &nbsp;<span class="gensmall">[ <a href="{guest_user_row.U_GUEST_IP_LOOKUP}" class="gensmall">{guest_user_row.L_GUEST_IP_LOOKUP}?</a> ]</span>&nbsp;</td>
  </tr>
  <!-- END guest_user_row -->
</table>
<br />