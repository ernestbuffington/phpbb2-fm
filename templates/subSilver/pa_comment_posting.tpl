...
<table width="100%" cellspacing="2" cellpadding="2" align="center">
  <tr>
	<td class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> -> <a href="{U_DOWNLOAD_HOME}" class="nav">{DOWNLOAD}</a><!-- BEGIN navlinks --> -> <a href="{navlinks.U_VIEW_CAT}" class="nav">{navlinks.CAT_NAME}</a><!-- END navlinks --> -> <a href="{U_FILE_NAME}" class="nav">{FILE_NAME}</a> -> {L_COMMENT_ADD}</td>
  </tr>
</table>
...
<table cellpadding="4" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
		<td class="row1"><span class="postbody">{PRE_COMMENT}</span></td>
	</tr>
</table>
<br />
<!-- ENDIF -->

<table cellpadding="4" cellspacing="1" width="100%" class="forumline" id="posting_body"><form action="{S_POST_ACTION}" method="post" name="post" onsubmit="return checkForm(this)">
	<tr> 
		<th class="thHead" colspan="2">{L_COMMENT_ADD}</th>
	</tr>
	<tr>
		<td class="row1" width="22%"><b class="gen">{L_COMMENT_TITLE}:</b></td>
		<td class="row2" width="78%"><input type="text" name="subject" size="45" maxlength="60" style="width:510px" tabindex="2" class="post" value="{SUBJECT}" /></td>
	</tr>
	<tr> 
	  <td class="row1" valign="top"><table width="100%" cellspacing="0" cellpadding="1">
		  <tr> 
			<td><b class="gen">{L_COMMENT}:</b></td>
		  </tr>
		  <tr> 
	...
	<tr>
	  ...
	  <td class="row2" valign="top"><table width="510" cellspacing="0" cellpadding="2">
		...
		<!-- END XBBcode -->
		  ...
		  <tr> 
		<td class="gensmall"><input type="text" name="helpbox" size="50" style="width:510px; font-size:10px" class="helpline" value="{L_STYLES_TIP}" /></td>
		  </tr>
		  <tr>
			<td align="left"><table width="100%">
			<tr> 
			<td valign="top"><textarea name="message" rows="17" cols="35" wrap="virtual" style="width:510px" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{COMMENT}</textarea></td>
	...
	<tr>
		<td class="row1" valign="top"><b class="gen">{L_OPTIONS}:</b><br /><span class="gensmall">{HTML_STATUS}<br />{BBCODE_STATUS}<br />{SMILIES_STATUS}<br />{LINKS_STATUS}<br />{IMAGES_STATUS}</span></td>
		<td class="row2"><span class="genmed">{L_COMMENT_EXPLAIN}<br /><a href="javascript:checklength(document.post);">{L_CHECK_MSG_LENGTH}</a></span></td>
	</tr>
	<tr> 
	  <td class="catBottom" colspan="2" align="center">{S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="5" name="preview" class="mainoption" value="{L_PREVIEW}" />&nbsp;&nbsp;<input type="submit" accesskey="s" tabindex="6" name="submit" class="mainoption" value="{L_SUBMIT}" onclick="this.onclick = new Function('return false');" />
	  <script language="JavaScript" type="text/javascript"> 
	  <!-- 
