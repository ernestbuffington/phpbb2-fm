...
<tr>
	<td class="row2" colspan="5" align="center"><b class="gensmall">{TOTAL_TEXT} &nbsp; {ALERT_EDIT}</b></td>
</tr>
<tr>
...
<tr> 
	...
	<td width="5%" class="{list.list_row.ROW_CLASS}" align="center"><input type="checkbox" name="mark[]2" value="{list.list_row.S_MARK_ID}"></td>
</tr>
<!-- END list_row -->
<tr> 
	<td class="catBottom" align="right" colspan="5"><span class="genmed">{list.L_MOVE}
