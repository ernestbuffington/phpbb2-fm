...
<tr> 
	<td class="catHead" align="center" colspan="{NUM_COLUMNS}"><span class="cattitle">{MODULE_NAME}</span></td> 
</tr> 
<tr>    
<!-- BEGIN column -->
...
<!-- BEGIN row_column -->
	...
	<!-- ELSEIF row.row_column.GRAPH_COLUMN -->
		<td class=<!-- IF row.row_column.ROW is even -->"row1"<!-- ELSE -->"row2"<!-- ENDIF --> align="{row.row_column.ALIGNMENT}" width="50%"> 
			...
			<tr> 
				<td align="right"><img src="{LEFT_GRAPH_IMAGE}" height="12" alt="" title="" /></td> 
			</tr> 
			</table> 
			<table cellspacing="0" cellpadding="0" align="left" width="{row.row_column.VALUE}%"> 
			<tr> 
				<td><img src="{GRAPH_IMAGE}" width="100%" height="12" alt="" title="" /></td> 
			</tr> 
			</table> 
			<table cellspacing="0" cellpadding="0" align="left"> 
			<tr> 
				<td align="left"><img src="{RIGHT_GRAPH_IMAGE}" height="12" alt="" title="" /></td> 
			</tr> 
			</table> 
		</td> 
	<!-- ELSE -->
