...
<script language="Javascript" src="mods/calendar/calendar.js"></script>
...
<tr> 
	...
	-> <a href="{U_VIEW_FORUM}" class="nav">{FORUM_NAVNAME}</a>
	<!-- BEGIN reply_mode -->
	...
	<td align="right" nowrap="nowrap" class="nav">{INBOX} :: {SENTBOX} :: {OUTBOX} :: {SAVEBOX} :: {EXPORT} {MASS_PM}</td>
	<!-- END switch_privmsg -->
...
<div id="preview_box" name="preview_box">{POST_PREVIEW_BOX}</div>

<table cellpadding="4" cellspacing="1" width="100%" class="forumline" id="posting_body"><form action="{S_POST_ACTION}" method="post" name="post" onsubmit="return checkForm(this)" {S_FORM_ENCTYPE}>
<tr> 
...
<tr> 
	...
	<td class="row2"><span class="genmed"><input type="text" class="post" tabindex="1" name="username" size="25" maxlength="{LIMIT_USERNAME_MAX_LENGTH}" value="{USERNAME}" /></span></td>
</tr>
<!-- END switch_username_select -->
<!-- BEGIN switch_privmsg -->
<tr> 
	<td class="row1"><b class="gen">{L_USERNAME}:</b></td>
	<td class="row2"><span class="genmed"><input type="text" class="post" name="username" size="25" maxlength="{LIMIT_USERNAME_MAX_LENGTH}" tabindex="1" value="{USERNAME}"{AJAXED_USER_LIST} />&nbsp;<input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" />{AJAXED_USER_LIST_BOX}</span></td>
</tr>
<input type="hidden" name="reply" value="{REPLY}" /><input type="hidden" name="id" value="{REPLY_ID}" />
<!-- END switch_privmsg -->
<!-- BEGIN switch_groupmsg -->
<tr> 
	<td class="row1"><b class="gen">{L_USERGROUPS}:</b></td>
	<td class="row2"><span class="genmed">{USERNAME}</span></td>
</tr>
<!-- END switch_groupmsg -->
<!-- BEGIN switch_msgicon_checkbox --> 
<tr> 
	<td class="row1"><b class="gen">{L_TOPIC_ICON}:</b></td> 
	<td class="row2"><table cellspacing="0" cellpadding="2"> 
	<tr>
		<td><span class="genmed"><input type="radio" name="msg_icon" value="0" {MSG_ICON_CHECKED0}>{L_NONE}</span></td>
		<td><input type="radio" name="msg_icon" value="1" {MSG_ICON_CHECKED1}> <img src="templates/{T_NAV_STYLE}/icon/icon1.gif" align="abscenter" /> 
		<input type="radio" name="msg_icon" value="2" {MSG_ICON_CHECKED2}> <img src="templates/{T_NAV_STYLE}/icon/icon2.gif" align="abscenter" /> 
		<input type="radio" name="msg_icon" value="3" {MSG_ICON_CHECKED3}> <img src="templates/{T_NAV_STYLE}/icon/icon3.gif" align="abscenter" /> 
		<input type="radio" name="msg_icon" value="4" {MSG_ICON_CHECKED4}> <img src="templates/{T_NAV_STYLE}/icon/icon4.gif" align="abscenter" /> 
		<input type="radio" name="msg_icon" value="5" {MSG_ICON_CHECKED5}> <img src="templates/{T_NAV_STYLE}/icon/icon5.gif" align="abscenter" /> 
		<input type="radio" name="msg_icon" value="6" {MSG_ICON_CHECKED6}> <img src="templates/{T_NAV_STYLE}/icon/icon6.gif" align="abscenter" /> 
		<input type="radio" name="msg_icon" value="7" {MSG_ICON_CHECKED7}> <img src="templates/{T_NAV_STYLE}/icon/icon7.gif" align="abscenter" /> 
		<input type="radio" name="msg_icon" value="8" {MSG_ICON_CHECKED8}> <img src="templates/{T_NAV_STYLE}/icon/icon8.gif" align="abscenter" /> 
		<input type="radio" name="msg_icon" value="9" {MSG_ICON_CHECKED9}> <img src="templates/{T_NAV_STYLE}/icon/icon9.gif" align="abscenter" /> 
		<input type="radio" name="msg_icon" value="10" {MSG_ICON_CHECKED10}> <img src="templates/{T_NAV_STYLE}/icon/icon10.gif" align="abscenter" /> 
		</td>
	</tr>
	</table></td> 
</tr> 
...
<tr> 
	...
	<td class="row2" width="78%"><input type="text" {S_LOCK_SUBJECT} name="subject" size="45" maxlength="120" style="width:510px" tabindex="2" class="post" value="{SUBJECT}" /></td>
</tr>
<tr> 
	...
	<tr align="center" valign="middle"> 
		...
		<tr> 
			...
			<tr> 
				<td valign="top"><textarea name="message" rows="17" cols="35" wrap="virtual" style="width:510px" tabindex="3" class="post" onselect="storeCaret(this);{DO_CHANGE}" onclick="storeCaret(this);{DO_CHANGE}" onkeyup="storeCaret(this);{DO_CHANGE};">{MESSAGE}</textarea></td>
				<td valign="top" align="right"><table width="100%" cellspacing="0" cellpadding="0"> 
				<script language="JavaScript" type="text/javascript">
				<!-- 
					rgb(30,4,1) 
				// --> 
	...
	<!-- BEGIN switch_cal_form -->
	<tr>
		<td class="row1"><b class="gen">{L_CALENDAR_EVENT}:</b><br /><span class="gensmall">{L_EVENT_START}</span></td>
		<td class="row2" style="vertical-align: middle;"><span class="gensmall"><input type="text" class="post" name="cal_date" size="10" maxlength="10" onFocus="this.blur();" style="vertical-align: middle;" value="{CAL_DATE}" /> <a href="javascript: void(0);" onClick="return getCalendar(document.post.cal_date);"><img src="mods/calendar/calendar.gif" align="absmiddle" /></a> <input type="button" class="liteoption" style="vertical-align: middle;" onClick="this.form.cal_date.value = '{CAL_NO_DATE}'; this.form.cal_date_end.value = '{CAL_NO_DATE}';" value="{L_CLEAR_DATE}" /> <input type="checkbox" name="cal_interval_date" value="1" style="vertical-align: middle;" onClick="if (document.getElementById) { toggle_cal_form_advanced = document.getElementById('cal_form_advanced').style; } else { alert('Upgrade your browser!'); return; } if (toggle_cal_form_advanced.display == 'none') { toggle_cal_form_advanced.display = ''; } else { toggle_cal_form_advanced.display = 'none'; }" {CAL_ADVANCED_FORM_ON}/> {L_CALENDAR_ADVANCED}</span></td>
	</tr>
	<tr id="cal_form_advanced" style="display: {CAL_ADVANCED_FORM};">
		<td class="row1"><b class="gen">{L_CALENDAR_EVENT}:</b><br /><span class="gensmall">{L_EVENT_END}</span></td>
		<td class="row2" style="vertical-align: middle;"><span class="gensmall"><input type="text" class="post" name="cal_date_end" size="10" maxlength="10" onFocus="this.blur();" style="vertical-align: middle;" value="{CAL_DATE_END}" /> <a href="javascript: void(0);" onClick="if (document.post.cal_date.value == '{CAL_NO_DATE}') { alert('{L_SELECT_START_DATE}'); return; } return getCalendar(document.post.cal_date_end);"><img src="mods/calendar/calendar.gif" align="absmiddle" /></a> <input type="button" class="liteoption" style="vertical-align: middle;" onClick="this.form.cal_date_end.value = '{CAL_NO_DATE}';" value="{L_CLEAR_DATE}" /> <input type="text" class="post" name="cal_interval" value="{CAL_INTERVAL}" size="3" style="vertical-align: middle;" /> <select class="post" name="cal_interval_units" style="vertical-align: middle;">{CAL_INTERVAL_UNIT_OPTIONS}</select> <input type="checkbox" name="cal_repeat_always" value="1" style="vertical-align: middle;" onClick="if (this.checked) { this.form.cal_date_end.value = '{CAL_NO_DATE}' }" {CAL_REPEAT_ALWAYS}/> {L_CAL_REPEAT_FOREVER}</span></td>
	</tr>
	<tr>
		<td class="row1"><b class="gen">{L_EVENT_TYPE_OPTION}:</b></td>
		<td class="row2" style="vertical-align: middle;"><span class="gensmall">{EVENT_TYPES}</span></td>
	</tr>
	<!-- END switch_cal_form -->
	<!-- BEGIN switch_password_box -->
	<tr> 
		<td class="row1"><b class="gen">{L_TOPIC_PASSWORD}:</b></td>
		<td class="row2"><input type="text" name="topicpassword" value="{TOPIC_PASSWORD}" size="30" maxlength="20" class="post" /></td>
	</tr>
	<!-- END switch_password_box -->
	<tr> 
	  <td class="row1" valign="top"><b class="gen">{L_OPTIONS}:</b><br /><span class="gensmall">{HTML_STATUS}<br />{BBCODE_STATUS}<br />{SMILIES_STATUS}</span></td>
	  <td class="row2"><span class="gen"> </span> 
		<table cellspacing="0" cellpadding="1">
		  <!-- BEGIN switch_html_checkbox -->
		  <tr> 
			<td><input type="checkbox" name="disable_html" {S_HTML_CHECKED} /></td>
			<td align="left" class="gen">{L_DISABLE_HTML}</td>
		  </tr>
		  <!-- END switch_html_checkbox -->
		  <!-- BEGIN switch_bbcode_checkbox -->
		  <tr> 
			<td><input type="checkbox" name="disable_bbcode" {S_BBCODE_CHECKED} /></td>
			<td align="left" class="gen">{L_DISABLE_BBCODE}</td>
		  </tr>
		  <!-- END switch_bbcode_checkbox -->
		  <!-- BEGIN switch_smilies_checkbox -->
		  <tr> 
			<td><input type="checkbox" name="disable_smilies" {S_SMILIES_CHECKED} /></td>
			<td align="left" class="gen">{L_DISABLE_SMILIES}</td>
		  </tr>
		  <!-- END switch_smilies_checkbox -->
		  <!-- BEGIN switch_signature_checkbox -->
		  <tr> 
			<td><input type="checkbox" name="attach_sig" {S_SIGNATURE_CHECKED} /></td>
			<td align="left" class="gen">{L_ATTACH_SIGNATURE}</td>
		  </tr>
		  <!-- END switch_signature_checkbox -->
		  <!-- BEGIN switch_notify_checkbox -->
		  <tr> 
			<td><input type="checkbox" name="notify" {S_NOTIFY_CHECKED} /></td>
			<td align="left" class="gen">{L_NOTIFY_ON_REPLY}</td>
		  </tr>
		  <!-- END switch_notify_checkbox -->
		  <!-- BEGIN switch_urgent_checkbox --> 
		   <tr> 
			 <td><input type="checkbox" name="urgent_post" {S_URGENT_CHECKED} /></td> 
			 <td align="left" class="gen">{L_URGENT_POST}</td> 
		   </tr> 
		  <!-- END switch_urgent_checkbox --> 
		  <!-- BEGIN switch_delete_checkbox -->
		  <tr> 
			<td><input type="checkbox" name="delete" /></td>
			<td align="left" class="gen">{L_DELETE_POST}</td>
		  </tr>
		  <!-- END switch_delete_checkbox -->
		  <!-- BEGIN switch_locktopic_checkbox -->
		  <tr> 
			<td><input type="checkbox" name="locktopic" {S_LOCK_TOPIC_CHECKED} /></td>
			<td align="left" class="gen">{L_LOCK_TOPIC}</td>
		  </tr>
		  <!-- END switch_locktopic_checkbox -->
		  <!-- BEGIN switch_type_toggle -->
		  <tr> 
			<td align="left" colspan="2" class="gen">{S_TYPE_TOGGLE}</td>
		  </tr>
	...
	<!-- END switch_confirm -->
	<tr> 
	  <td class="catBottom" colspan="2" align="center">{S_HIDDEN_FORM_FIELDS}<input type="submit"{AJAXED_PREVIEW} tabindex="5" name="preview" class="liteoption" value="{L_PREVIEW}" />&nbsp;&nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" onclick="this.onclick = new Function('return false');" />&nbsp;
	  <script language="JavaScript" type="text/javascript"> 
	  <!-- 
