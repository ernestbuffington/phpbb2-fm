...
<!-- IF FILE_LIST -->
  ...
  <tr> 
	...
	<td class="row1" valign="middle"><a href="{files_row.U_FILE}" class="topictitle">{files_row.FILE_NAME}</a>&nbsp;<!-- IF files_row.IS_NEW_FILE --><img src="{files_row.FILE_NEW_IMAGE}" alt="{L_NEW_FILE}"><!-- ENDIF --><br /><span class="genmed">{files_row.FILE_DESC}</span></td>
