...
<tr>
	<td class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> -> <a href="{U_KB}" class="nav">{L_KB}</a></td>
</tr>
</table>

{KB_PREVIEW_BOX}

<table cellpadding="4" cellspacing="1" width="100%" class="forumline"><form method="post" action="{S_ACTION}" onsubmit="return checkForm(this)" name="post">
<tr>
	<th class="thHead" colspan="2">{L_ADD_ARTICLE}</th>
</tr>
<tr>
	<td colspan="2" class="row2"><span class="gensmall">{PRETEXT_BODY} {L_ITEMS_REQUIRED}</span></td>
</tr>
<!-- BEGIN switch_name -->
<tr> 
	<td class="row1"><b class="gen">{L_NAME}:</b></td>
	<td class="row2"><input type="text" name="username" size="45" maxlength="100" style="width:510px" class="post" value="{USERNAME}" /></td>
</tr>
<!-- END switch_name -->
<tr> 
	<td class="row1" width="22%"><b class="gen">{L_ARTICLE_TITLE}: *</b></td>
	<td class="row2" width="78%"><input type="text" name="article_name" size="35" maxlength="100" style="width:300px" class="post" value="{ARTICLE_TITLE}" /></td>
</tr>
<tr> 
	<td class="row1"><b class="gen">{L_ARTICLE_DESCRIPTION}: *</b></td>
	<td class="row2"><input type="text" name="article_desc" size="45" maxlength="255" style="width:510px" class="post" value="{ARTICLE_DESC}" /></td>
</tr>
<tr> 
	<td class="row1" valign="top"><table width="100%" cellspacing="0" cellpadding="1">
	<tr> 
	<td><b class="gen">{L_ARTICLE_TEXT}: *</b></td>
	</tr>
	<tr> 
...
<br /><br /><b class="gen">{L_OPTIONS}:</b><br /><span class="gensmall">{HTML_STATUS}<br />{BBCODE_STATUS}<br />{SMILIES_STATUS}</span></td>
	...
	<tr align="center" valign="middle"> 
		...
		<tr> 
			...
			<tr> 
				<td valign="top"><textarea name="message" rows="16" cols="35" wrap="virtual" style="width:510px" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{ARTICLE_BODY}</textarea></td>
...
<tr> 
	<td class="row1"><b class="gen">{L_ARTICLE_TYPE}:</b></td>
	<td class="row2"><select name="type_id">
   		<!-- BEGIN types -->
   		{types.TYPE}
   		<!-- END types -->
	</select></td>
...
<!-- BEGIN switch_edit -->
<tr>
	<td class="row1"><b class="gen">{L_ARTICLE_CATEGORY}:</b></td>
    	<td class="row2"><select name="category_id">
		<!-- BEGIN categories -->
    		{switch_edit.categories.CATEGORY}
		<!-- END categories -->
	</select></td>
</tr>
<tr> 
	<td class="row1"><b class="gen">{L_TOPIC} ID:</b></td>
	<td class="row2"><input type="text" name="topic" size="10" maxlength="10" class="post" value="{TOPIC}" /></td>
</tr>
<!-- END switch_edit -->
<tr> 
	<td class="catBottom" colspan="2" align="center">{S_HIDDEN_FIELDS}<input type="submit" name="preview" value="{L_PREVIEW}" class="liteoption" />&nbsp;&nbsp;<input type="submit" name="article_submit" class="mainoption" value="{L_SUBMIT}" onclick="this.onclick = new Function('return false');" />&nbsp;
	<script language="JavaScript" type="text/javascript"> 
	<!-- 
