...
<tr>
	...
	<td class="row2" width="78%"><input type="text" name="subject" size="45" maxlength="120" style="width:410px" tabindex="2" class="post" value="{SUBJECT}" /></td>
</tr>
<tr>
...
<tr>
	  <td class="row1" valign="top"><b class="gen">{L_OPTIONS}:</b><br /><span class="gensmall">{BBCODE_STATUS}<br />{SMILIES_STATUS}</span></td>
	<td class="row2"><span class="gen"> </span> 
	<table cellspacing="0" cellpadding="1">
	<!-- BEGIN switch_bbcode_checkbox -->
	<tr> 
		<td><input type="checkbox" name="bbcode" value="1" {switch_bbcode_checkbox.S_BBCODE_CHECKED} /></td>
		<td align="left" class="gen">{L_DISABLE_BBCODE}</td>
	</tr>
	<!-- END switch_bbcode_checkbox -->
	<!-- BEGIN switch_smilies_checkbox -->
	<tr> 
		<td><input type="checkbox" name="smilies" value="1" {switch_smilies_checkbox.S_SMILIES_CHECKED} /></td>
...
<tr>
	<td class="catBottom" colspan="2" align="center"><input tabindex="5" type="submit" name="post" class="mainoption" value="{L_SUBMIT}" />&nbsp;&nbsp;<input tabindex="6" type="submit" name="cancel" class="liteoption" value="{L_CANCEL}" />
	<!-- BEGIN switch_spellcheck -->
	&nbsp;<input type="button" class="liteoption" value="{L_SPELLCHECK}" name="button" onclick="openspell();">
	<!-- END switch_spellcheck -->
	<!-- BEGIN switch_popup -->
	&nbsp;&nbsp;<input tabindex="7" type="submit" name="close" class="liteoption" value="{L_CLOSE}" onClick="javascript:window.close()">
	<!-- END switch_popup -->
	</td>
</tr>
</form></table>
