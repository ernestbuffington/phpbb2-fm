...
<form method="get" name="ualbum" action="{U_DOWNLOAD}">
	...
	<td class="slideshow" nowrap="nowrap">
		...
		document.write('<a href="/" onMouseOver="this.href=CreateLink(document.ualbum.u);" onClick="location.href=CreateLink(document.ualbum.u); return false;"><img src="{MINI_SEARCH_IMG}" vspace="4" hspace="2" /></a><noinput');
		//-->
		</script><input type="image" src="{MINI_SEARCH_IMG}" vspace="4" hspace="2" />
		&nbsp; &nbsp;
	</td>{HIDDEN_SID}
</form>
<form method="get" name="malbum" action="{U_DOWNLOAD}">
	...
	<td class="slideshow" nowrap="nowrap">
		...
		document.write('<a href="/" onMouseOver="this.href=CreateLink(document.malbum.m);" onClick="location.href=CreateLink(document.malbum.m); return false;"><img src="{MINI_SEARCH_IMG}" vspace="4" hspace="2" /></a><noinput');
		//-->
		</script><input type="image" src="{MINI_SEARCH_IMG}" vspace="4" hspace="2" />
		&nbsp;
	</td>{HIDDEN_SID}
		...
		<td align="right"><table cellpadding="0" cellspacing="7">
			<tr>
...
<form method="get" name="ss" action="{U_DOWNLOAD}">
	<td align="center"><table cellpadding="0" cellspacing="0">
		<tr>
			<td valign="bottom" height="31"><table cellpadding="0" cellspacing="0"><tr><td height="30" class="slideshow" nowrap="nowrap">
			<script language="Javascript1.2" type="text/javascript">
			<!--
