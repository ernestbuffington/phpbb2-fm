...
<table width="100%" cellpadding="4" cellspacing="1" class="forumline" id="posting_body"><form action="{U_SHOUTBOX}" method="post" name="post" onsubmit="return checkForm(this)">
  <tr> 
	<th class="thHead" colspan="2">{L_POST_SHOUT}</th>
  </tr>
<!-- BEGIN switch_username_select -->
  <tr> 
	<td class="row1"><b class="gen">{L_USERNAME}</b></td>
	<td class="row2"><input type="text" class="post" tabindex="1" name="username" size="25" maxlength="25" value="{USERNAME}" /></span></td>
  </tr>
<!-- END switch_username_select -->
  <tr> 
	<td class="row1" valign="top" width="22%"><table width="100%" cellspacing="0" cellpadding="1">
<tr>
<td><b class="gen">{L_SHOUT_BODY}:</b></td>
</tr>
	  <tr> 
	  ...
	  <tr align="center" valign="middle"> 
		<td><span class="genmed"> 
		  ...
		  <tr> 
			<td colspan="6" align="center"><select name="addbbcodefontcolor" onChange="bbfontstyle('[color=' + this.form.addbbcodefontcolor.options[this.form.addbbcodefontcolor.selectedIndex].value + ']', '[/color]');this.selectedIndex=0;" onMouseOver="helpline('s')">
			...
			</select> &nbsp; <select name="addbbcodefontsize" onChange="bbfontstyle('[size=' + this.form.addbbcodefontsize.options[this.form.addbbcodefontsize.selectedIndex].value + ']', '[/size]')" onMouseOver="helpline('f')">
				...
				<option style="background-color: {T_TD_COLOR1}" value="0" class="genmed" selected="selected">{L_FONT_FACE}</option>
				<!-- BEGIN font_styles -->
				<option style="background-color: {T_TD_COLOR1}" value="{font_styles.L_FONTNAME}" class="genmed" style="font-family:{font_styles.L_FONTNAME};">{font_styles.L_FONTNAME}</option>
				<!-- END font_styles -->
			</select></td>
		...
		<table width="100%" cellspacing="2" cellpadding="2">
			...
			<td colspan="8" align="center"><select name="addbbcodetextalign" onChange="bbfontstyle('[align=' + this.form.addbbcodetextalign.options[this.form.addbbcodetextalign.selectedIndex].value + ']', '[/align]')" onMouseOver="helpline('c')">
				<option style="background-color: {T_TD_COLOR1}" selected>{L_ALIGN_TEXT}</option>
				<option style="background-color: {T_TD_COLOR1}" value="left" class="genmed">{L_LEFT}</option>
				<option style="background-color: {T_TD_COLOR1}" value="center" class="genmed">{L_CENTER}</option>
				<option style="background-color: {T_TD_COLOR1}" value="right" class="genmed">{L_RIGHT}</option>
				<option style="background-color: {T_TD_COLOR1}" value="justify" class="genmed">{L_JUSTIFY}</option>
				...
				<option style="background-color: {T_TD_COLOR1}" value="{T_FONTCOLOR1}" class="genmed">{L_HIGHLIGHT_COLOR}</option>
 				<option style="color:coral; background-color: {T_TD_COLOR1}" value="coral" class="genmed">{L_COLOR_CORAL}</option>
 				<option style="color:crimson; background-color: {T_TD_COLOR1}" value="crimson" class="genmed">{L_COLOR_CRIMSON}</option>
				<option style="color:tomato; background-color: {T_TD_COLOR1}" value="tomato" class="genmed">{L_COLOR_TOMATO}</option>
				<option style="color:seagreen; background-color: {T_TD_COLOR1}" value="seagreen" class="genmed">{L_COLOR_SEA_GREEN}</option>
		...
		<tr> 
			...
			<tr> 
				<td valign="top"><textarea name="message" rows="16" cols="35" wrap="virtual" style="width:510px" tabindex="3" class="post" onselect="storeCaret(this);doChange();" onclick="storeCaret(this);doChange();" onkeyup="storeCaret(this);doChange();">{MESSAGE}</textarea></td>
  ...
  <tr> 
	<td class="catBottom" colspan="2" align="center">{S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="5" name="preview" class="liteoption" value="{L_PREVIEW}" />&nbsp;&nbsp;<input type="submit" accesskey="s" tabindex="6" name="shout" class="mainoption" value="{L_SUBMIT}" onclick="this.onclick = new Function('return false');" />&nbsp;&nbsp;<input type="submit" tabindex="5" name="refresh" class="liteoption" value="{L_REFRESH}" />
	<!-- BEGIN switch_spellcheck -->
...
<table width="100%" cellspacing="2" align="center" cellpadding="2">
  <tr> 
	...
	<td align="right" valign="middle" nowrap><br />{JUMPBOX}</td> 
  </tr> 
</table> 
