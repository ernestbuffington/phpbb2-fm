...
<table width="100%" cellpadding="2" cellspacing="1" class="forumline">
	<tr>
		<th colspan="3" class="thTop" nowrap="nowrap">{switch_newmsg_list.L_NEW_MESSAGES}</th>
	</tr>
	<tr>
...
<table width="100%" cellpadding="2" cellspacing="1" class="forumline">
	<tr>
		<th colspan="3" class="thTop" nowrap="nowrap">{switch_users_online.L_USERS_ONLINE}</th>
	</tr>
...
<table width="100%" cellpadding="2" cellspacing="1" class="forumline">
	<tr>
		<th colspan="2" class="thTop" nowrap="nowrap">{switch_network_boxes.L_NETWORK_TITLE}</th>
	</tr>
	{USER_BOX}
</table>
