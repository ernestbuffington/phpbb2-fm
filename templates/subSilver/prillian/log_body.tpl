...
<!-- BEGIN switch_controls_images -->
	<div class="prill_widectrlimg">
		<a href="{U_SEND_IM}" target="newmessage" onClick="javascript:opener.new_message('{U_SEND_IM}'); return false"><img src="{IMG_MESSAGE}" alt="{L_ALT_MESSAGE}" width="19" height="15" /></a>
		<a href="{U_CONTACT_MAN}" target="phpbbmain"><img src="{IMG_CONTACT}" alt="{L_ALT_CONTACT}" width="19" height="15" /></a>
		<a href="{U_INDEX}" target="phpbbmain"><img src="{IMG_HOME}" alt="{L_ALT_HOME}" width="16" height="15" /></a>
		<a href="javascript:opener.kill_spawn()"><img src="{IMG_CLOSE_WINDOWS}" alt="{L_ALT_CLOSE_WINDOWS}" width="19" height="15" /></a>
		<a href="{U_LOGIN_LOGOUT}" target="phpbbmain" onClick="javascript:opener.shut_down('{U_LOGIN_LOGOUT}')"><img src="{IMG_LOGOUT}" alt="{L_ALT_LOGOUT}" width="16" height="15" /></a>
		<a href="{U_HELP}" target="phpbbmain"><img src="{IMG_HELP}" alt="{L_ALT_HELP}" width="17" height="15" /></a>
	</div>
<!-- END switch_controls_images -->

	<a href="http://darkmods.sourceforge.net" target="_blank"><!--img src="{IMG_LOGO}" alt="{L_PRILLIAN}" width="145" height="24" vspace="3" /-->PRILLIAN</a>
</div>
