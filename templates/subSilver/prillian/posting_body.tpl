...
<table cellpadding="4" cellspacing="1" width="98%" class="forumline">
	<tr>
				...
				<tr>
					...
					<td align="center">
						...
						<select name="smile_url" onchange="javascript:update_smiley(this.options[selectedIndex].value);">
							<option selected value="images/spacer.gif">{L_SELECT_SMILE}</option>
							<!-- BEGIN smilies_row -->
						...
						<a href="javascript:emoticon(document.post.smile_url.options[document.post.smile_url.selectedIndex].id);"><img name="smiley_image" src="images/spacer.gif" alt="" title="" /></a>
	...
	<tr>
		<td class="catBottom" colspan="2" align="center">{S_HIDDEN_FORM_FIELDS}<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" /> <input type="reset" accesskey="r" tabindex="7" name="post" class="liteoption" value="{L_RESET}" /> <input type="button" tabindex="8" value="{L_CLOSE_WINDOW}" class="liteoption" onClick="window.close()" /></td>
	</tr>
</form></table>
