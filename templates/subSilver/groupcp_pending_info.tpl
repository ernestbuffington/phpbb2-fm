...
<table width="100%" cellpadding="4" cellspacing="1" class="forumline">
	...
	<tr> 
	  ...
	  <td class="{pending_members_row.ROW_CLASS}" align="center">{pending_members_row.ONLINE_STATUS_IMG}</td>
	...
	<tr> 
	  <td class="catBottom" colspan="8" align="right"><input type="submit" name="approve" value="{L_APPROVE_SELECTED}" class="mainoption" />&nbsp;&nbsp;<input type="submit" name="deny" value="{L_DENY_SELECTED}" class="liteoption" /></td>
	</tr>
</table>
