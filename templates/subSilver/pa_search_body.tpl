...
<tr>
	<td class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> -> <a href="{U_DOWNLOAD}" class="nav">{DOWNLOAD}</a> -> {L_SEARCH}</td>
</tr>
</table>
<table width="100%" cellpadding="3" cellspacing="1" class="forumline"><form action="{S_SEARCH_ACTION}" method="post">
<tr> 
...
<tr> 
	...
	<td class="row2"><input type="text" style="width: 300px" class="post" name="search_keywords" size="30" /><br /><input type="radio" name="search_terms" value="any" checked="checked" /> {L_SEARCH_ANY_TERMS}<br /><input type="radio" name="search_terms" value="all" /> {L_SEARCH_ALL_TERMS}</td>
</tr>
<tr> 
	<td class="row1"><b>{L_SEARCH_AUTHOR}:</b><br /><span class="gensmall">{L_SEARCH_AUTHOR_EXPLAIN}</span></td>
	<td class="row2"><input type="text" style="width: 300px" class="post" name="search_author" size="30" /></td>
</tr>
<tr> 
...
<tr> 
	...
	<td class="row2"><select name="cat_id">
		<option value="0" selected>{L_ALL}</option>
		{S_CAT_MENU}
	</select></td>
</tr>
<tr> 
...
<tr>
	...
	<td class="row2"><input type="radio" name="sort_order" value="ASC" /> {L_SORT_ASCENDING}&nbsp;&nbsp;<input type="radio" name="sort_order" value="DESC" checked /> {L_SORT_DESCENDING}</td>
</tr>  
<tr>   
