...
<tr>
	<td class="row1" width="22%"><b>{L_MEETING_SUBJECT}:</b><br /><span class="gensmall">{MEETING_BY_USER} {MEETING_EDIT_BY_USER}</span></td>
	<td class="row2" width="78%"><input type="text" class="post" name="meeting_subject" size="50" maxlength="255" value="{MEETING_SUBJECT}" /></td>
</tr>
<tr>
	<td class="row1"><b>{L_MEETING_LOCATION}:</b></td>
	<td class="row2"><input type="text" class="post" name="meeting_location" size="50" maxlength="255" value="{MEETING_LOCATION}" /></td>
</tr>
<tr>
	<td class="row1"><b>{L_MEETING_LINK}:</b></td>
	<td class="row2"><input type="text" class="post" name="meeting_link" size="50" maxlength="255" value="{MEETING_LINK}" /></td>
</tr>
<tr>
	...
	<tr>
		<td><textarea class="post" name="message" rows="16" cols="35" wrap="virtual" style="width:510px">{MEETING_DESC}</textarea></td>
	</tr>
	</table></td>
</tr>
<tr>
