	...
	switch($mode)
	{
		...
		case 'editforum':
			...
			if ($mode == 'editforum')
			{
				...
				$topic_password = $row['topic_password'];
			...
			else
			{
				...
				$display_pic_alert = $index_lasttitle = $forum_toggle = $forum_external = $forum_ext_newwin = $forumissub = $forumposts = $forumtopics = $image_ever_thumb = $events_forum = $icon_enable = $answered_enable = $amazon_display = $forum_views = $forum_digest = $forum_enter_limit = $forumstatus = $forumthank = $hidestatus = $catstatus = $topic_password = FORUM_UNLOCKED;
			...
			$template->assign_vars(array(
				...
				'TOPIC_PASSWORD_YES' => ($topic_password) ? 'checked="checked"' : '',
				'TOPIC_PASSWORD_NO' => (!$topic_password) ? 'checked="checked"' : '',
				...
				'L_TOPIC_PASSWORD_EXPLAIN' => $lang['Topic_password_explain'],
		...
		case 'createforum':
			...
			$message = $lang['Forums_updated'] . "<br /><br />" . sprintf($lang['Click_return_setperms'], "<a href=\"" . append_sid("admin_forumauth.$phpEx?adv=1&amp;" . POST_FORUM_URL . "=$next_id") . "\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_forumadmin'], "<a href=\"" . append_sid("admin_forums.$phpEx") . "\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_admin_index'], "<a href=\"" . append_sid("index.$phpEx?pane=right") . "\">", "</a>");
		...
		case 'modforum':
			...
			$message = $lang['Forums_updated'] . "<br /><br />" . sprintf($lang['Click_return_setperms'], "<a href=\"" . append_sid("admin_forumauth.$phpEx?adv=1&amp;" . POST_FORUM_URL . "=$forum_id") . "\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_forumadmin'], "<a href=\"" . append_sid("admin_forums.$phpEx") . "\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_admin_index'], "<a href=\"" . append_sid("index.$phpEx?pane=right") . "\">", "</a>");
