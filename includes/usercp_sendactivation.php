...
*
* @package includes
* @version $Id: usercp_sendactivation.php,v 1.6.2.12 2004/11/18 17:49:45 acydburn Exp $
...
if ( isset($HTTP_POST_VARS['submit']) )
{
	...
	if ( $result = $db->sql_query($sql) )
	{
		if ( $row = $db->sql_fetchrow($result) )
		{
			...
			$emailer->set_subject($lang['New_activation']);
			...
			$message = $lang['New_activation_sent'] . '<br /><br />' . sprintf($lang['Click_return_index'],  '<a href="' . append_sid("index.$phpEx") . '">', '</a>');
...
// Output basic page
//
$page_title = $lang['Resend_Activation'];
...
$template->assign_vars(array(
	...
	'L_SEND_PASSWORD' => $lang['Resend_Activation'], 
