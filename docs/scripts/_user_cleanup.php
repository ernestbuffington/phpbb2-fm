...
$tables = array(
	...
	ATTACH_QUOTA_TABLE => $default_field,
	$table_prefix . 'avatartoplist' => 'voter_id',
	...
	$table_prefix . 'im_prefs' => $default_field,
	$table_prefix . 'im_sessions' => 'session_' . $default_field,
	$table_prefix . 'ina_ban' => 'id',
	$table_prefix . 'ina_challenge_tracker' => 'user',
	$table_prefix . 'ina_challenge_users' => 'user_to OR user_from',
	$table_prefix . 'ina_cheat_fix ' => 'player',
	$table_prefix . 'ina_favorites' => 'user',
	$table_prefix . 'ina_gamble_in_progress' => 'sender_id OR reciever_id',
	$table_prefix . 'ina_last_game_played' => $default_field,
	$table_prefix . 'ina_hall_of_fame' => 'current_' . $default_field . ' OR old_' . $default_field,
	$table_prefix . 'ina_rating_votes' => 'player',
	$table_prefix . 'ina_sessions' => 'playing_id',
	$table_prefix . 'ina_top_scores' => 'player',
	$table_prefix . 'ina_trophy_comments' => 'player',
	EMPLOYED_TABLE => $default_field,
	$table_prefix . 'links' => $default_field,
	$table_prefix . 'link_comments' => 'poster_id',
	$table_prefix . 'link_votes' => $default_field,
