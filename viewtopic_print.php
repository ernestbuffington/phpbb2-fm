...
*
* @package phpBB2
* @version $Id: viewtopic_print.php,v 1.1 2002/03/20 17:49:37 adam ismay Exp $
* @copyright (c) 2002 Adam Ismay
...
if( !$is_auth['auth_read'] )
{
	...
	{
		$redirect = "t=" . $topic_id;
		header("Location: " . append_sid("login.$phpEx?redirect=viewtopic_print.$phpEx&$redirect", true));
	}
