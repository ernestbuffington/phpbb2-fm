...
$sql[] = 'CREATE TABLE ' . $prefix . 'advance_html (`config_name` VARCHAR(255) DEFAULT "" NOT NULL, `config_value` LONGTEXT, PRIMARY KEY (config_name))';
...
$sql[] = 'CREATE TABLE '. $prefix .'album_comment (comment_id int(11) UNSIGNED NOT NULL auto_increment, comment_pic_id int(11) UNSIGNED NOT NULL, comment_cat_id INT(11) NOT NULL, comment_user_id MEDIUMINT(8) NOT NULL, comment_user_ip char(8) NOT NULL, comment_time int(11) UNSIGNED NOT NULL, comment_text TEXT, comment_edit_time int(11) UNSIGNED, comment_edit_count smallint(5) UNSIGNED DEFAULT "0" NOT NULL, comment_edit_user_id MEDIUMINT(8), comment_username VARCHAR(32), PRIMARY KEY (comment_id), KEY comment_pic_id(comment_pic_id), KEY comment_user_id(comment_user_id), KEY comment_user_ip(comment_user_ip), KEY comment_time(comment_time)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'album_config';
$sql[] = 'CREATE TABLE '. $prefix .'album_config (config_name VARCHAR(255) NOT NULL, config_value VARCHAR(255) NOT NULL, PRIMARY KEY (config_name)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'album_rate';
$sql[] = 'CREATE TABLE '. $prefix .'album_rate (rate_pic_id int(11) UNSIGNED NOT NULL, rate_user_id MEDIUMINT(8) NOT NULL, rate_user_ip char(8) NOT NULL, rate_point tinyint(3) UNSIGNED NOT NULL, rate_hon_point TINYINT(3) DEFAULT "0" NOT NULL, KEY rate_pic_id (rate_pic_id), KEY rate_user_ip(rate_user_ip), KEY rate_point(rate_point)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'attach_quota';
$sql[] = 'CREATE TABLE '. $prefix .'attach_quota (user_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, group_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, quota_type SMALLINT(2) DEFAULT "0" NOT NULL, quota_limit_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, KEY quota_type (quota_type)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'attachments';
$sql[] = 'CREATE TABLE '. $prefix .'attachments (attach_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, post_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, privmsgs_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, user_id_1 MEDIUMINT(8) NOT NULL, user_id_2 MEDIUMINT(8) NOT NULL, KEY attach_id_post_id (attach_id, post_id), KEY attach_id_privmsgs_id (attach_id, privmsgs_id), KEY post_id (post_id), KEY privmsgs_id (privmsgs_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'attachments_config';
$sql[] = 'CREATE TABLE '. $prefix .'attachments_config (config_name VARCHAR(255) NOT NULL, config_value VARCHAR(255) NOT NULL, PRIMARY KEY (config_name)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'attachments_desc';
$sql[] = 'CREATE TABLE '. $prefix .'attachments_desc (attach_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, physical_filename VARCHAR(255) NOT NULL, real_filename VARCHAR(255) NOT NULL, download_count MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, comment VARCHAR(255), extension VARCHAR(100), mimetype VARCHAR(100), filesize INT(20) NOT NULL, filetime INT(11) DEFAULT "0" NOT NULL, thumbnail TINYINT(1) DEFAULT "0" NOT NULL, width smallint(5) UNSIGNED DEFAULT "0" NOT NULL, height smallint(5) UNSIGNED DEFAULT "0" NOT NULL, border tinyint(1) DEFAULT "0" NOT NULL, PRIMARY KEY (attach_id), KEY filetime (filetime), KEY physical_filename(physical_filename(10)), KEY filesize(filesize), INDEX (filetime), INDEX (physical_filename(10)), INDEX (filesize)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'avatartoplist';
$sql[] = 'CREATE TABLE ' . $prefix . 'avatartoplist (`avatar_filename` TEXT NOT NULL, `avatar_type` tinyint(4) NOT NULL default "0", `voter_id` mediumint(8) NOT NULL, `voting` mediumint(8) NOT NULL, `comment` text NOT NULL, INDEX `voter_id` (`voter_id`)) TYPE=MyISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'cat_rel_cat_parents (cat_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, parent_cat_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, PRIMARY KEY (cat_id,parent_cat_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'cat_rel_forum_parents';
$sql[] = 'CREATE TABLE '. $prefix .'cat_rel_forum_parents (cat_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, parent_forum_id SMALLINT(5) UNSIGNED DEFAULT "0" NOT NULL, PRIMARY KEY (cat_id,parent_forum_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'charts';
$sql[] = 'CREATE TABLE '. $prefix .'charts (chart_id MEDIUMINT(8) NOT NULL auto_increment, chart_song_name VARCHAR(100) NOT NULL, chart_artist VARCHAR(100) NOT NULL, chart_album VARCHAR(100) DEFAULT "", chart_label VARCHAR(100) NOT NULL, chart_catno VARCHAR(50) NOT NULL, chart_website VARCHAR(100) NOT NULL, chart_poster_id VARCHAR(100) NOT NULL, chart_hot MEDIUMINT(8) DEFAULT "0", chart_not MEDIUMINT(8) DEFAULT "0", chart_curr_pos MEDIUMINT(8) DEFAULT "0", chart_last_pos MEDIUMINT(8) DEFAULT "0", chart_best_pos MEDIUMINT(8) DEFAULT "0", PRIMARY KEY (chart_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'charts_voters';
$sql[] = 'CREATE TABLE '. $prefix .'charts_voters (vote_id MEDIUMINT(8) NOT NULL auto_increment, vote_user_id MEDIUMINT(8) NOT NULL, vote_chart_id MEDIUMINT(8) NOT NULL, vote_rate SMALLINT(2) NOT NULL, PRIMARY KEY (vote_id), FOREIGN KEY (vote_chart_id) REFERENCES '. $prefix .'charts (chart_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'chatbox';
$sql[] = 'CREATE TABLE '. $prefix .'chatbox (id INT(11) NOT NULL auto_increment, name VARCHAR(99) NOT NULL, msg VARCHAR(255) NOT NULL, timestamp INT(10) UNSIGNED NOT NULL, PRIMARY KEY (id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'chatbox_session';
$sql[] = 'CREATE TABLE '. $prefix .'chatbox_session (username VARCHAR(99) NOT NULL, lastactive INT(10) DEFAULT "0" NOT NULL, laststatus VARCHAR(8) NOT NULL, UNIQUE username (username)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'config_nav';
$sql[] = 'CREATE TABLE '. $prefix .'config_nav (navlink_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, img VARCHAR(100) DEFAULT "" NOT NULL, alt VARCHAR(100) DEFAULT "" NOT NULL, use_lang TINYINT(1) DEFAULT "1" NOT NULL, url VARCHAR(255) DEFAULT "" NOT NULL, nav_order MEDIUMINT(8) UNSIGNED DEFAULT "1" NOT NULL, value TINYINT(1) DEFAULT "0" NOT NULL, PRIMARY KEY (navlink_id)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'extension_groups (group_id MEDIUMINT(8) NOT NULL auto_increment, group_name CHAR(20) NOT NULL, cat_id TINYINT(2) DEFAULT "0" NOT NULL, allow_group TINYINT(1) DEFAULT "0" NOT NULL, download_mode TINYINT(1) UNSIGNED DEFAULT "1" NOT NULL, upload_icon VARCHAR(100) DEFAULT "", max_filesize INT(20) DEFAULT "0" NOT NULL, forum_permissions VARCHAR(255) DEFAULT "" NOT NULL, PRIMARY KEY group_id (group_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'extensions';
$sql[] = 'CREATE TABLE '. $prefix .'extensions (ext_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, group_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, extension VARCHAR(100) NOT NULL, comment VARCHAR(100), PRIMARY KEY ext_id (ext_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'flags';
$sql[] = 'CREATE TABLE '. $prefix .'flags (flag_id INT(10) NOT NULL auto_increment, flag_name VARCHAR(255), flag_image VARCHAR(255), PRIMARY KEY (flag_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'forbidden_extensions';
$sql[] = 'CREATE TABLE '. $prefix .'forbidden_extensions (ext_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, extension VARCHAR(100) NOT NULL, PRIMARY KEY (ext_id)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'forum_tour (page_id MEDIUMINT(8) UNSIGNED NOT NULL, page_subject VARCHAR(60) null, page_text text, page_sort MEDIUMINT(8) NOT NULL, bbcode_uid CHAR(10) DEFAULT "" NOT NULL, page_access MEDIUMINT(8) NOT NULL, KEY (page_id)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE ' . $prefix . 'forums_watch (`forum_id` MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, `user_id` MEDIUMINT(8) DEFAULT "0" NOT NULL, `notify_status` TINYINT(1) DEFAULT "0" NOT NULL, KEY forum_id (forum_id), KEY user_id (user_id), KEY notify_status (notify_status)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'helpdesk_emails (e_id int(10) DEFAULT "0" NOT NULL, e_addr VARCHAR(255) DEFAULT NULL)';
		
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'helpdesk_importance';
$sql[] = 'CREATE TABLE '. $prefix .'helpdesk_importance (value int(10) DEFAULT "0", data text)';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'helpdesk_msgs';
$sql[] = 'CREATE TABLE '. $prefix .'helpdesk_msgs (e_id int(10) DEFAULT "0", e_msg VARCHAR(255) DEFAULT NULL)';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'helpdesk_reply';
$sql[] = 'CREATE TABLE '. $prefix .'helpdesk_reply (value int(10) DEFAULT "0", data text)';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_ban';
$sql[] = 'CREATE TABLE '. $prefix .'ina_ban (id int(10) DEFAULT "0" NOT NULL, username VARCHAR(40) DEFAULT NULL)';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_categories';
$sql[] = 'CREATE TABLE '. $prefix .'ina_categories (cat_id MEDIUMINT(9) NOT NULL auto_increment, cat_name VARCHAR(25) DEFAULT NULL, cat_desc text NOT NULL, cat_img VARCHAR(255) DEFAULT "" NOT NULL, PRIMARY KEY (cat_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_challenge_tracker';
$sql[] = 'CREATE TABLE '. $prefix .'ina_challenge_tracker (user int(10) DEFAULT "0", count int(25) DEFAULT "0")';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_challenge_users';
$sql[] = 'CREATE TABLE '. $prefix .'ina_challenge_users (user_to int(10) DEFAULT "0", user_from int(10) DEFAULT "0", count int(25) DEFAULT "0")';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_chat';
$sql[] = 'CREATE TABLE '. $prefix .'ina_chat (`chat_date` DATE NOT NULL DEFAULT "0000-00-00", `chat_text` TEXT NOT NULL)';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_cheat_fix';
$sql[] = 'CREATE TABLE '. $prefix .'ina_cheat_fix (`game_id` int(10) DEFAULT "0" NOT NULL, `player` int(10) DEFAULT "0") TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_data';
$sql[] = 'CREATE TABLE '. $prefix .'ina_data (version VARCHAR(255) DEFAULT NULL)';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_favorites';
$sql[] = 'CREATE TABLE '. $prefix .'ina_favorites (user int(10) DEFAULT "0" NOT NULL, games text)';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_gamble';
$sql[] = 'CREATE TABLE '. $prefix .'ina_gamble (game_id int(20) DEFAULT "0", sender_id int(11) DEFAULT "0", reciever_id int(11) DEFAULT "0", amount int(10) DEFAULT "0", winner_id int(11) DEFAULT "0", loser_id int(11) DEFAULT "0", winner_score int(11) DEFAULT "0", loser_score int(11) DEFAULT "0", date int(20) DEFAULT NULL, been_paid int(11) DEFAULT "0")';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_gamble_in_progress';
$sql[] = 'CREATE TABLE '. $prefix .'ina_gamble_in_progress (game_id int(20) DEFAULT "0", sender_id int(11) DEFAULT "0", reciever_id int(11) DEFAULT "0", sender_score int(20) DEFAULT "0", reciever_score int(20) DEFAULT "0", sender_playing int(1) DEFAULT "0" NOT NULL, reciever_playing int(1) DEFAULT "0" NOT NULL)';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_games';
$sql[] = 'CREATE TABLE '. $prefix .'ina_games (game_id MEDIUMINT(9) NOT NULL auto_increment, game_name VARCHAR(25) DEFAULT NULL, game_path VARCHAR(255) DEFAULT NULL, game_desc VARCHAR(255) DEFAULT NULL, game_charge int(11) UNSIGNED DEFAULT "0", game_reward int(11) UNSIGNED NOT NULL DEFAULT "0", game_bonus smallint(5) UNSIGNED DEFAULT "0", game_use_gl tinyint(3) UNSIGNED DEFAULT "0", game_flash tinyint(1) UNSIGNED NOT NULL DEFAULT "0", game_show_score tinyint(1) NOT NULL DEFAULT "1", win_width smallint(6) NOT NULL DEFAULT "0", win_height smallint(6) NOT NULL DEFAULT "0", highscore_limit VARCHAR(255) DEFAULT NULL, reverse_list tinyint(1) NOT NULL DEFAULT "0", played int(10) UNSIGNED NOT NULL DEFAULT "0", instructions text, disabled int(1) NOT NULL DEFAULT "1", install_date int(20) NOT NULL DEFAULT "0", proper_name text NOT NULL, cat_id int(4) NOT NULL DEFAULT "0", `jackpot` INT(10) NOT NULL DEFAULT "0", `game_popup` SMALLINT(1) NOT NULL DEFAULT "0", `game_parent` SMALLINT(1) NOT NULL DEFAULT "0", `game_type` SMALLINT(1) DEFAULT "1" NOT NULL, `game_links` TEXT NOT NULL, `game_ge_cost` INT(10) DEFAULT "0" NOT NULL, `game_keyboard` SMALLINT(1) DEFAULT "0" NOT NULL, `game_mouse` SMALLINT(1) DEFAULT "0" NOT NULL, PRIMARY KEY (game_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_hall_of_fame';
$sql[] = 'CREATE TABLE '. $prefix .'ina_hall_of_fame (`game_id` MEDIUMINT(8) NOT NULL DEFAULT "0", `current_user_id` MEDIUMINT(8) NOT NULL DEFAULT "0", `current_score` FLOAT(10,2) NOT NULL DEFAULT "0.00", `date_today` INT(10) NOT NULL DEFAULT "0", `old_user_id` MEDIUMINT(8) NOT NULL DEFAULT "0", `old_score` FLOAT(10,2) NOT NULL DEFAULT "0.00", `old_date` INT(10) NOT NULL DEFAULT "0")';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_last_game_played';
$sql[] = 'CREATE TABLE '. $prefix .'ina_last_game_played (`game_id` int(20) DEFAULT "0", `user_id` mediumint(8) NOT NULL, `date` int(20) DEFAULT NULL)';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_rating_votes';
$sql[] = 'CREATE TABLE '. $prefix .'ina_rating_votes (game_id int(15) NOT NULL DEFAULT "0", rating int(15) NOT NULL DEFAULT "0", date int(15) NOT NULL DEFAULT "0", player int(15) NOT NULL DEFAULT "0")';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_scores';
$sql[] = 'CREATE TABLE '. $prefix .'ina_scores (game_name VARCHAR(255) DEFAULT NULL, player VARCHAR(40) DEFAULT NULL, score float(10,2) NOT NULL DEFAULT "0.00", date int(11) DEFAULT NULL, `user_plays` INT(6) DEFAULT "0" NOT NULL, `play_time` INT(10) DEFAULT "0" NOT NULL)';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_sessions';
$sql[] = 'CREATE TABLE '. $prefix .'ina_sessions (playing_time int(15) NOT NULL DEFAULT "0", playing_id int(10) NOT NULL DEFAULT "0", playing int(11) NOT NULL DEFAULT "0")';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_top_scores';
$sql[] = 'CREATE TABLE '. $prefix .'ina_top_scores (game_name VARCHAR(255) DEFAULT NULL, player MEDIUMINT(8) NOT NULL, score float(10,2) NOT NULL DEFAULT "0.00", date int(11) DEFAULT NULL)';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'ina_trophy_comments';
$sql[] = 'CREATE TABLE '. $prefix .'ina_trophy_comments (game VARCHAR(255) NOT NULL DEFAULT "", player int(10) DEFAULT NULL, comment text NOT NULL, date int(15) NOT NULL DEFAULT "0", score int(20) NOT NULL DEFAULT "0")';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'im_buddy_list';
$sql[] = 'CREATE TABLE '. $prefix .'im_buddy_list (user_id MEDIUMINT(8) DEFAULT "0" NOT NULL, contact_id MEDIUMINT(8) DEFAULT "0" NOT NULL, user_ignore TINYINT(1) DEFAULT "0" NOT NULL, alert TINYINT(1) DEFAULT "0" NOT NULL, alert_status TINYINT(1) DEFAULT "0" NOT NULL, disallow TINYINT(1) DEFAULT "0" NOT NULL, display_name VARCHAR(25) DEFAULT "" NOT NULL, KEY contact_id (contact_id), KEY user_id (user_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'im_config';
$sql[] = 'CREATE TABLE '. $prefix .'im_config (config_name VARCHAR(255) DEFAULT "" NOT NULL, config_value VARCHAR(255) DEFAULT "" NOT NULL, PRIMARY KEY (config_name)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'im_prefs';
$sql[] = 'CREATE TABLE '. $prefix .'im_prefs (user_id MEDIUMINT(8) DEFAULT "0" NOT NULL, user_allow_ims TINYINT(1) DEFAULT "0" NOT NULL, user_allow_shout TINYINT(1) DEFAULT "1" NOT NULL, user_allow_chat TINYINT(1) DEFAULT "1" NOT NULL, user_allow_network TINYINT(1) DEFAULT "0" NOT NULL, admin_allow_ims TINYINT(1) DEFAULT "1" NOT NULL, admin_allow_shout TINYINT(1) DEFAULT "1" NOT NULL, admin_allow_chat TINYINT(1) DEFAULT "1" NOT NULL, admin_allow_network TINYINT(1) DEFAULT "1" NOT NULL, new_ims SMALLINT(5) UNSIGNED DEFAULT "0" NOT NULL, unread_ims SMALLINT(5) UNSIGNED DEFAULT "0" NOT NULL, read_ims SMALLINT(5) UNSIGNED DEFAULT "0" NOT NULL, total_sent MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, attach_sig TINYINT(1) DEFAULT "1" NOT NULL, refresh_rate SMALLINT(5) UNSIGNED DEFAULT "120" NOT NULL, success_close TINYINT(1) DEFAULT "1" NOT NULL, refresh_method TINYINT(1) DEFAULT "1" NOT NULL, auto_launch TINYINT(1) DEFAULT "1" NOT NULL, popup_ims TINYINT(1) DEFAULT "1" NOT NULL, list_ims TINYINT(1) DEFAULT "0" NOT NULL, show_controls TINYINT(1) DEFAULT "1" NOT NULL, list_all_online TINYINT(1) DEFAULT "1" NOT NULL, DEFAULT_mode TINYINT(1) DEFAULT "1" NOT NULL, current_mode TINYINT(1) DEFAULT "1" NOT NULL, mode1_height VARCHAR(4) DEFAULT "400" NOT NULL, mode1_width VARCHAR(4) DEFAULT "230" NOT NULL, mode2_height VARCHAR(4) DEFAULT "225" NOT NULL, mode2_width VARCHAR(4) DEFAULT "400" NOT NULL, mode3_height VARCHAR(4) DEFAULT "100" NOT NULL, mode3_width VARCHAR(4) DEFAULT "400" NOT NULL, prefs_width VARCHAR(4) DEFAULT "500" NOT NULL, prefs_height VARCHAR(4) DEFAULT "350" NOT NULL, read_height VARCHAR(4) DEFAULT "3000" NOT NULL, read_width VARCHAR(4) DEFAULT "400" NOT NULL, send_height VARCHAR(4) DEFAULT "365" NOT NULL, send_width VARCHAR(4) DEFAULT "460" NOT NULL, play_sound TINYINT(1) DEFAULT "1" NOT NULL, DEFAULT_sound TINYINT(1) DEFAULT "1" NOT NULL, sound_name VARCHAR(255) DEFAULT NULL, themes_id MEDIUMINT(8) UNSIGNED DEFAULT "1" NOT NULL, network_user_list TINYINT(1) DEFAULT "1" NOT NULL, open_pms TINYINT(1) DEFAULT "0" NOT NULL, auto_delete TINYINT(1) DEFAULT "0" NOT NULL, use_frames TINYINT(1) DEFAULT "1" NOT NULL, user_override TINYINT(1) DEFAULT "0" NOT NULL, PRIMARY KEY (user_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'im_sessions';
$sql[] = 'CREATE TABLE '. $prefix .'im_sessions (session_user_id MEDIUMINT(8) DEFAULT "0" NOT NULL, session_id CHAR(32) DEFAULT "" NOT NULL, session_time INT(11) DEFAULT "0" NOT NULL, session_popup TINYINT(1) DEFAULT "0" NOT NULL, PRIMARY KEY (session_id), KEY session_user_id (session_user_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'im_sites';
$sql[] = 'CREATE TABLE '. $prefix .'im_sites (site_id MEDIUMINT(8) NOT NULL auto_increment, site_name VARCHAR(50) NOT NULL, site_url VARCHAR(100) NOT NULL, site_phpex VARCHAR(4) DEFAULT "php" NOT NULL, site_profile VARCHAR(50) DEFAULT "profile" NOT NULL, site_enable TINYINT(1) DEFAULT "1" NOT NULL, PRIMARY KEY (site_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS ' . $prefix . 'inline_ads'; 
$sql[] = 'CREATE TABLE ' . $prefix . 'inline_ads (`ad_id` TINYINT(5) NOT NULL auto_increment, `ad_code` TEXT NOT NULL, `ad_name` CHAR(25) NOT NULL, PRIMARY KEY (ad_id)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'kb_articles (article_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, article_category_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, article_title VARCHAR(255) BINARY DEFAULT "" NOT NULL, article_description VARCHAR(255) BINARY DEFAULT "" NOT NULL, article_date VARCHAR(255) BINARY DEFAULT "" NOT NULL, article_author_id MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT "0", username VARCHAR(255), bbcode_uid CHAR(10) DEFAULT "" NOT NULL, article_body TEXT NOT NULL, article_type MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, approved TINYINT(1) UNSIGNED DEFAULT "0" NOT NULL, topic_id MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT "0", views BIGINT(8) DEFAULT "0" NOT NULL, KEY article_id (article_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'kb_categories';
$sql[] = 'CREATE TABLE '. $prefix .'kb_categories (category_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, category_name VARCHAR(255) BINARY NOT NULL, category_details VARCHAR(255) BINARY NOT NULL, number_articles MEDIUMINT(8) UNSIGNED NOT NULL, parent MEDIUMINT(8) UNSIGNED NOT NULL, cat_order MEDIUMINT(8) UNSIGNED NOT NULL, KEY category_id (category_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'kb_types';
$sql[] = 'CREATE TABLE '. $prefix .'kb_types (id INT(4) NOT NULL auto_increment, type VARCHAR(255) DEFAULT "0" NOT NULL, UNIQUE KEY id (id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'kb_results';
$sql[] = 'CREATE TABLE '. $prefix .'kb_results (search_id INT(11) UNSIGNED DEFAULT "0" NOT NULL, session_id VARCHAR(32) DEFAULT "" NOT NULL, search_array mediumtext NOT NULL, PRIMARY KEY (search_id), KEY session_id (session_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'kb_wordlist';
$sql[] = 'CREATE TABLE '. $prefix .'kb_wordlist (word_text VARCHAR(50) BINARY DEFAULT "0" NOT NULL, word_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, word_common TINYINT(1) UNSIGNED DEFAULT "0" NOT NULL, PRIMARY KEY (word_text), KEY word_id (word_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'kb_wordmatch';
$sql[] = 'CREATE TABLE '. $prefix .'kb_wordmatch (article_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, word_id MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, title_match TINYINT(1) DEFAULT "0" NOT NULL, KEY post_id (article_id), KEY word_id (word_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS ' . $prefix . 'lexicon'; 
$sql[] = 'CREATE TABLE ' . $prefix . 'lexicon (`id` BIGINT(8) NOT NULL auto_increment, `keyword` VARCHAR(250) NOT NULL DEFAULT "", `explanation` LONGTEXT NOT NULL, `bbcode_uid` CHAR(10) DEFAULT "" NOT NULL, `cat` INT(8) NOT NULL DEFAULT "1", PRIMARY KEY (id), KEY (cat)) TYPE=MYISAM';
			
$sql[] = 'DROP TABLE IF EXISTS ' . $prefix . 'lexicon_cat';
$sql[] = 'CREATE TABLE ' . $prefix . 'lexicon_cat (`cat_id` INT(8) NOT NULL auto_increment, `cat_titel` VARCHAR(80) NOT NULL DEFAULT "", PRIMARY KEY (cat_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'links';
$sql[] = 'CREATE TABLE '. $prefix .'links (link_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, link_name TEXT, link_longdesc TEXT, link_catid MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, link_url VARCHAR(100) DEFAULT "" NOT NULL, link_logo_src VARCHAR(100) DEFAULT NULL, link_time int(25) DEFAULT "0", link_approved tinyint(1) DEFAULT "0" NOT NULL, link_hits int(10) UNSIGNED DEFAULT "0" NOT NULL, user_id MEDIUMINT(8) DEFAULT "0" NOT NULL, poster_ip VARCHAR(8) NOT NULL, last_user_ip VARCHAR(8) DEFAULT "" NOT NULL, post_username VARCHAR(25) DEFAULT NULL, link_pin INT(2) DEFAULT "0", PRIMARY KEY (link_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'link_categories';
$sql[] = 'CREATE TABLE '. $prefix .'link_categories (cat_id INT(10) NOT NULL auto_increment, cat_name TEXT DEFAULT NULL, cat_order INT(50), cat_parent INT(50) DEFAULT NULL, parents_data TEXT NOT NULL, cat_links MEDIUMINT(8) NOT NULL DEFAULT "-1", PRIMARY KEY (cat_id), KEY cat_order (cat_order)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'link_config';
$sql[] = 'CREATE TABLE '. $prefix .'link_config (`config_name` VARCHAR(255) DEFAULT "" NOT NULL, `config_value` VARCHAR(255) DEFAULT "" NOT NULL, PRIMARY KEY(`config_name`)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'lottery_history (`id` int UNSIGNED NOT NULL auto_increment, `user_id` int(10) NOT NULL, `amount` int(10) NOT NULL, `time` int(10) NOT NULL, PRIMARY KEY (`id`), INDEX (user_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'lottery';
$sql[] = 'CREATE TABLE '. $prefix .'lottery (`id` int UNSIGNED NOT NULL auto_increment, `user_id` int(10) NOT NULL, PRIMARY KEY (`id`), INDEX(user_id)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'meeting_user (`meeting_id` MEDIUMINT(8) UNSIGNED NOT NULL, `user_id` MEDIUMINT(8) DEFAULT "0" NOT NULL, `meeting_sure` tinyint(4) DEFAULT "0" NOT NULL, `meeting_guests` MEDIUMINT(8) NOT NULL DEFAULT "0")';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'meeting_usergroup';
$sql[] = 'CREATE TABLE '. $prefix .'meeting_usergroup (`meeting_id` MEDIUMINT(8) UNSIGNED NOT NULL, `meeting_group` MEDIUMINT(8) NOT NULL)';
...
$sql[] = 'CREATE TABLE '. $prefix .'pa_files (file_id INT(10) NOT NULL auto_increment, user_id MEDIUMINT(8) DEFAULT "0" NOT NULL, poster_ip VARCHAR(8) NOT NULL, file_name TEXT, file_size INT(20) NOT NULL, unique_name VARCHAR(255) NOT NULL, real_name VARCHAR(255) NOT NULL, file_dir VARCHAR(255) NOT NULL, file_desc TEXT, file_creator TEXT, file_version TEXT, file_longdesc TEXT, file_ssurl TEXT, file_sshot_link TINYINT(2) DEFAULT "0" NOT NULL, file_dlurl TEXT, file_time INT(50) DEFAULT NULL, file_update_time INT(50) NOT NULL, file_catid INT(10) DEFAULT NULL, file_posticon TEXT, file_license INT(10) DEFAULT NULL, file_dls INT(10) DEFAULT NULL, file_last INT(50) DEFAULT NULL, file_pin INT(2) DEFAULT NULL, file_docsurl TEXT, file_approved TINYINT(2) DEFAULT "0" NOT NULL, file_broken TINYINT(1) DEFAULT "0" NOT NULL, PRIMARY KEY (file_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'pa_license';
$sql[] = 'CREATE TABLE '. $prefix .'pa_license (license_id INT(10) NOT NULL auto_increment, license_name TEXT, license_text TEXT, PRIMARY KEY (license_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'pa_mirrors';
$sql[] = 'CREATE TABLE '. $prefix .'pa_mirrors (mirror_id MEDIUMINT(8) NOT NULL auto_increment, file_id INT(10) NOT NULL, unique_name VARCHAR(255) DEFAULT "" NOT NULL, file_dir VARCHAR(255) NOT NULL, file_dlurl VARCHAR(255) DEFAULT "" NOT NULL, mirror_location VARCHAR(255) DEFAULT "" NOT NULL, PRIMARY KEY (mirror_id), KEY file_id (file_id)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'pa_votes';
$sql[] = 'CREATE TABLE '. $prefix .'pa_votes (user_id MEDIUMINT(8) DEFAULT "0" NOT NULL, votes_ip VARCHAR(50) DEFAULT "0" NOT NULL, votes_file INT(50) DEFAULT "0" NOT NULL, rate_point TINYINT(3) UNSIGNED NOT NULL,  voter_os VARCHAR(255) NOT NULL, voter_browser VARCHAR(255) NOT NULL, browser_version VARCHAR(8) NOT NULL, KEY user_id (user_id)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'pjirc (pjirc_name VARCHAR(255) DEFAULT "" NOT NULL, pjirc_value VARCHAR(255) DEFAULT "" NOT NULL, PRIMARY KEY (pjirc_name)) TYPE=MYISAM';		
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'points_logger';
$sql[] = 'CREATE TABLE '. $prefix .'points_logger (id MEDIUMINT(8) auto_increment, admin VARCHAR(25) NOT NULL, person VARCHAR(25) NOT NULL, add_sub VARCHAR(50) NOT NULL, total MEDIUMINT(8) DEFAULT "0" NOT NULL, time int(11) DEFAULT "0" NOT NULL, PRIMARY KEY (id)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'rating_temp (`topic_id` INT UNSIGNED NOT NULL, `points` TINYINT NOT NULL, KEY `ratingtemp_topicid` (topic_id))';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'referers';
$sql[] = 'CREATE TABLE '. $prefix .'referers (referer_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, referer_host VARCHAR(255) DEFAULT "" NOT NULL, referer_url VARCHAR(255) DEFAULT "" NOT NULL, referer_ip VARCHAR(8) DEFAULT "" NOT NULL, referer_hits INT(10) DEFAULT "1" NOT NULL, referer_firstvisit INT(11) DEFAULT "0" NOT NULL, referer_lastvisit INT(11) DEFAULT "0" NOT NULL, PRIMARY KEY (referer_id)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'referral';
$sql[] = 'CREATE TABLE '. $prefix .'referral (referral_id MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, ruid VARCHAR(7) DEFAULT "0" NOT NULL, nuid VARCHAR(7) DEFAULT "0" NOT NULL, referral_time VARCHAR(10) DEFAULT "" NOT NULL, KEY referraler_id(referral_id)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'shop_items (id INT UNSIGNED NOT NULL auto_increment, name CHAR(32) NOT NULL, shop CHAR(32) NOT NULL, sdesc CHAR(80) NOT NULL, ldesc TEXT NOT NULL, cost INT(20) UNSIGNED DEFAULT "100", stock TINYINT(3) UNSIGNED DEFAULT "10", maxstock TINYINT(3) UNSIGNED DEFAULT "100", sold INT(5) UNSIGNED DEFAULT "0" NOT NULL, accessforum INT(4) DEFAULT "0", PRIMARY KEY (id), INDEX(name)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'shop_transactions';
$sql[] = 'CREATE TABLE '. $prefix .'shop_transactions (shoptrans_date INT(11) DEFAULT "0" NOT NULL, trans_user MEDIUMINT(8) NOT NULL, trans_item VARCHAR(32) DEFAULT "" NOT NULL, trans_type VARCHAR(255) DEFAULT "" NOT NULL, trans_total MEDIUMINT(8) DEFAULT "0" NOT NULL, PRIMARY KEY(shoptrans_date)) TYPE=MYISAM';
...
$sql[] = 'CREATE TABLE '. $prefix .'thanks(`topic_id` MEDIUMINT(8) NOT NULL, `user_id` MEDIUMINT(8) NOT NULL, `thanks_time` INT(11) NOT NULL) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'thread_kicker';
$sql[] = 'CREATE TABLE '. $prefix .'thread_kicker(`kick_id` INT(11) NOT NULL auto_increment, `user_id` INT(11) NOT NULL DEFAULT "0", `topic_id` INT(11) NOT NULL DEFAULT "0", `kicker` INT(11) NOT NULL DEFAULT "0", `post_id` INT(11) NOT NULL DEFAULT "0", `kick_time` INT(11) NOT NULL DEFAULT "0", `kicker_status` INT(2) NOT NULL DEFAULT "0", `kicker_username` VARCHAR(25) NOT NULL DEFAULT "", `kicked_username` VARCHAR(25) NOT NULL DEFAULT "", `topic_title` VARCHAR(120) NOT NULL DEFAULT "", PRIMARY KEY (`kick_id`)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'title_infos';
$sql[] = 'CREATE TABLE '. $prefix .'title_infos (`id` INT(11) NOT NULL auto_increment, `title_info` VARCHAR(255) NOT NULL, `info_color` VARCHAR(6) default "" NOT NULL, `date_format` VARCHAR(25), `title_pos` TINYINT(1) DEFAULT "0" NOT NULL, `admin_auth` TINYINT(1) DEFAULT "0", `supermod_auth` TINYINT(1) DEFAULT "0", `mod_auth` TINYINT(1) DEFAULT "0", `poster_auth` TINYINT(1) DEFAULT "0", UNIQUE (`id`)) TYPE=MYISAM';
		
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'topics_viewdata';
$sql[] = 'CREATE TABLE '. $prefix . 'topics_viewdata (`viewed_id` INT(10) UNSIGNED NOT NULL auto_increment, `user_id` MEDIUMINT(8) DEFAULT "0" NOT NULL, `topic_id` MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL, `num_views` TINYINT(4) UNSIGNED DEFAULT "1" NOT NULL, `last_viewed` INT(10) UNSIGNED DEFAULT "0" NOT NULL, PRIMARY KEY (viewed_id), KEY user_id (user_id, topic_id), KEY last_viewed (last_viewed)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'toplist';
$sql[] = 'CREATE TABLE '. $prefix .'toplist (id int(255) NOT NULL auto_increment, nam VARCHAR(255) NOT NULL DEFAULT "", inf VARCHAR(255) NOT NULL DEFAULT "", hin int(255) NOT NULL DEFAULT "0", lin VARCHAR(255) NOT NULL DEFAULT "", `out` int(255) NOT NULL DEFAULT "0", img int(255) NOT NULL DEFAULT "0", ban VARCHAR(255) NOT NULL DEFAULT "http://", owner int(255) NOT NULL DEFAULT "0", tot int(255) NOT NULL DEFAULT "0", imgfile VARCHAR(50) NOT NULL DEFAULT "button1", ip VARCHAR(8) NOT NULL, PRIMARY KEY (id)) TYPE=MYISAM';
...
$sql[] = 'TRUNCATE TABLE '. $prefix .'themes';
$sql[] = 'TRUNCATE TABLE '. $prefix .'themes';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'transactions';
$sql[] = 'CREATE TABLE '. $prefix .'transactions (trans_date int(11) DEFAULT "0" NOT NULL, trans_from VARCHAR(30) DEFAULT "" NOT NULL, trans_to VARCHAR(30) DEFAULT "" NOT NULL, trans_amount MEDIUMINT(8) DEFAULT "0" NOT NULL, trans_reason VARCHAR(255) DEFAULT "" NOT NULL, PRIMARY KEY (trans_date)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'unique_hits';
$sql[] = 'CREATE TABLE '. $prefix .'unique_hits (user_ip char(8) DEFAULT "0" NOT NULL, time int(11) DEFAULT "0" NOT NULL, INDEX (user_ip)) TYPE=MYISAM';

$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'user_notes';
$sql[] = 'CREATE TABLE '. $prefix . 'user_notes (`post_id` MEDIUMINT(8) UNSIGNED NOT NULL auto_increment, `poster_id` MEDIUMINT(8) DEFAULT "0" NOT NULL, `post_subject` VARCHAR(120) DEFAULT NULL, `post_text` TEXT, `post_time` INT(11) DEFAULT "0" NOT NULL, `bbcode_uid` CHAR(10) DEFAULT "" NOT NULL, `bbcode` TINYINT(1) DEFAULT "1" NOT NULL, `smilies` TINYINT(1) DEFAULT "1" NOT NULL, `acronym` TINYINT(1) DEFAULT "1" NOT NULL, PRIMARY KEY (post_id), KEY poster_id (poster_id), KEY post_time (post_time)) TYPE=MYISAM';
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'user_shops';
$sql[] = 'CREATE TABLE '. $prefix . 'user_shops (`id` INT(5) NOT NULL auto_increment, `user_id` INT(10) NOT NULL, `username` VARCHAR(32) NOT NULL, `shop_name` VARCHAR(32) NOT NULL, `shop_type` VARCHAR(32) NOT NULL, `shop_opened` INT(30) NOT NULL, `shop_updated` INT(30) NOT NULL, `shop_status` INT(1) DEFAULT "0" NOT NULL, `amount_earnt` INT(10) DEFAULT "0" NOT NULL, `amount_holding` INT(10) DEFAULT "0" NOT NULL, `items_sold` INT(10) DEFAULT "0" NOT NULL, `items_holding` INT(10) UNSIGNED DEFAULT "0" NOT NULL, PRIMARY KEY (`user_id`), INDEX (`id`)) TYPE=MYISAM';
  			
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'user_shops_items';
$sql[] = 'CREATE TABLE '. $prefix . 'user_shops_items (`id` INT(10) NOT NULL auto_increment, `shop_id` INT(10) NOT NULL, `item_id` INT(10) NOT NULL, `seller_notes` VARCHAR(255) NOT NULL, `cost` INT(10) NOT NULL, `time_added` MEDIUMINT(30) NOT NULL, INDEX (`shop_id`), PRIMARY KEY (`id`)) TYPE=MYISAM';		
	
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'users_comments';
$sql[] = 'CREATE TABLE '. $prefix .'users_comments (comment_id MEDIUMINT(8) auto_increment NOT NULL, user_id MEDIUMINT(8) NOT NULL, poster_id MEDIUMINT(8) NOT NULL, comments TEXT NOT NULL, time INT(11) DEFAULT NULL, PRIMARY KEY (comment_id)) TYPE=MYISAM';
...
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'foing_song_status';
...
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'lexicon_config';
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'links_cat';
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'links_url';
$sql[] = 'DROP TABLE IF EXISTS '. $prefix .'links_urlincat';
