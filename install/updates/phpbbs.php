...
$sql[] = 'ALTER TABLE ' . $prefix . 'auth_access ADD COLUMN `auth_download` TINYINT(1) DEFAULT "0" NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'categories ADD COLUMN `cat_icon` VARCHAR(255) NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'categories ADD COLUMN `cat_sponsor_img` VARCHAR(255) NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'categories ADD COLUMN `cat_sponsor_alt` VARCHAR(255) NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'categories ADD COLUMN `cat_sponsor_url` VARCHAR(255) NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'forums ADD COLUMN `forum_views` MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'forums ADD COLUMN `forum_icon` VARCHAR(255) NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'forums ADD COLUMN `forum_enter_limit` MEDIUMINT(8) UNSIGNED DEFAULT "0" NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'forums ADD COLUMN `auth_download` TINYINT(2) DEFAULT "0" NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'forums ADD COLUMN `forum_external` TINYINT(1) NOT NULL DEFAULT "0"';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'forums MODIFY COLUMN `forum_id` SMALLINT(5) NOT NULL auto_increment';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'posts ADD COLUMN `post_edit_user` MEDIUMINT(8) DEFAULT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'posts ADD COLUMN `post_attachment` TINYINT(1) DEFAULT "0" NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'privmsgs ADD COLUMN `privmsgs_attachment` TINYINT(1) DEFAULT "0" NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'sessions ADD COLUMN `session_topic` INT(11) NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'sessions ADD COLUMN `is_robot` VARCHAR(255) DEFAULT "0" NOT NULL';

$sql[] = 'ALTER TABLE ' . $prefix . 'smilies ADD COLUMN `smilies_order` SMALLINT(5) DEFAULT "0" NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'topics ADD COLUMN `topic_attachment` TINYINT(1) DEFAULT "0" NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_clockformat` VARCHAR(12) DEFAULT "clock001.swf" NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_sound_pm` TINYINT(1) DEFAULT"0" NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `rating_status` TINYINT UNSIGNED NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_points` BIGINT(20) NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `admin_allow_points` TINYINT(1) DEFAULT "1" NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_lastlogon` INT(11) DEFAULT "0"';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_totaltime` INT(11) DEFAULT "0"';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_totallogon` SMALLINT(5) DEFAULT "0"';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_totalpages` INT(11) NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_birthday` MEDIUMINT(6) DEFAULT "999999" NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_next_birthday_greeting` INT DEFAULT "0" NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_from_flag` VARCHAR(25) NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_session_topic` INT(11) NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_gender` tinyint DEFAULT "0" NOT NULL';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_photo` VARCHAR(100)';
$sql[] = 'ALTER TABLE ' . $prefix . 'users ADD COLUMN `user_photo_type` TINYINT(4) DEFAULT "0" NOT NULL';
...
$sql[] = 'ALTER TABLE ' . $prefix . 'vote_voters ADD COLUMN `vote_cast` TINYINT(4) UNSIGNED DEFAULT "0" NOT NULL';
...
$sql[] = 'UPDATE ' . $prefix . 'config SET `config_value` = "1" WHERE `config_name` = "default_style"';

$sql[] = 'UPDATE ' . $prefix . 'users SET `user_style` = "1"'; 
$sql[] = 'UPDATE ' . $prefix . 'users SET `admin_allow_points` = "1" WHERE `user_id` > 0';
$sql[] = 'UPDATE ' . $prefix . 'users SET `user_lastlogon` = `user_lastvisit`';
$sql[] = 'UPDATE ' . $prefix . 'users SET `user_session_time` = `user_lastlogon`';
$sql[] = 'UPDATE ' . $prefix . 'users SET `user_totallogon` = 1 WHERE `user_session_time` <> 0';
