...
class pafiledb_main extends pafiledb_public
{
	function main($action)
	{
		...
		//===================================================
/*		include_once($phpbb_root_path . 'mods/pafiledb/includes/functions_menu.php');
		...
		$menu_output = implode('', file($phpbb_root_path . 'mods/pafiledb/lib/layersmenu-browser_detection.js'));
		$menu_output .= '<script language="JavaScript" type="text/javascript" src="' . $phpbb_root_path . 'mods/pafiledb/lib/layersmenu-library.js"></script>
									   <script language="JavaScript" type="text/javascript" src="' . $phpbb_root_path . 'mods/pafiledb/lib/layersmenu.js"></script>
									   <script language="JavaScript" type="text/javascript" src="' . $phpbb_root_path . 'mods/pafiledb/lib/layerstreemenu-cookies.js"></script>';
