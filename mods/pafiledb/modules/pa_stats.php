...
class pafiledb_stats extends pafiledb_public
{
	...
	{
		global $pafiledb_template, $lang, $board_config, $phpEx, $pafiledb_config, $db, $images, $theme;
		...
		foreach($os_point as $index => $point)
		{
			...
			$pafiledb_template->assign_block_vars("downloads_os", array(
				'OS_IMG' => "templates/" . $theme['template_name'] . "/images/stats/" . $os_image[$index],
		...
		foreach($agent_point as $index => $point)
		{
			...
			$pafiledb_template->assign_block_vars("downloads_b", array(
				'B_IMG' => "templates/" . $theme['template_name'] . "/images/stats/" . $agent_image[$index],
		...
		$pafiledb_template->assign_vars(array(
			...
			'U_VOTE_LCAP' => "templates/" . $theme['template_name'] . "/images/vote_lcap.gif",
			'U_VOTE_RCAP' => "templates/" . $theme['template_name'] . "/images/vote_rcap.gif",
