...
include($phpbb_root_path . 'mods/pafiledb/includes/pafiledb_constants.'.$phpEx);
include($phpbb_root_path . 'mods/pafiledb/includes/functions_cache.'.$phpEx);
include($phpbb_root_path . 'mods/pafiledb/includes/functions.'.$phpEx);
include($phpbb_root_path . 'mods/pafiledb/includes/template.'.$phpEx);
include($phpbb_root_path . 'mods/pafiledb/includes/functions_pafiledb.'.$phpEx);
