 ...
 *
 *   $Id: cancer.php,v 1.99.2.3 2004/07/11 16:46:15 acydburn Exp $
 *
 ***************************************************************************/
...
<title>' . $board_config['sitename'] . ' :: ' . $lang['Zodiac'] . ' - ' . $lang['Cancer'] . '</title>
	
<table class="forumline" width="100%" cellspacing="1" cellpadding="4">
<tr>
	<th class="thHead">' . $lang['Cancer'] . '</th>
</tr>
<tr> 
...
$horoscope->setSign('cancer');       // set valid sign (required)
