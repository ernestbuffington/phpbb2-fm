 ...
 *
 *   $Id: pisces.php,v 1.99.2.3 2004/07/11 16:46:15 acydburn Exp $
 *
 ***************************************************************************/
...
<title>' . $board_config['sitename'] . ' :: ' . $lang['Zodiac'] . ' - ' . $lang['Pisces'] . '</title>
	
<table class="forumline" width="100%" cellspacing="1" cellpadding="4">
<tr>
	<th class="thHead">' . $lang['Pisces'] . '</th>
</tr>
<tr> 
...
$horoscope->setSign('pisces');       // set valid sign (required)
