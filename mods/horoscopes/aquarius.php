 ...
 *
 *   $Id: aquarius.php,v 1.99.2.3 2004/07/11 16:46:15 acydburn Exp $
 *
 ***************************************************************************/
...
<title>' . $board_config['sitename'] . ' :: ' . $lang['Zodiac'] . ' - ' . $lang['Aquarius'] . '</title>
	
<table class="forumline" width="100%" cellspacing="1" cellpadding="4">
<tr>
	<th class="thHead">' . $lang['Aquarius'] . '</th>
</tr>
<tr> 
...
$horoscope->setSign('aquarius');    // set valid sign (required)
