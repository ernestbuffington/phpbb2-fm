	...
	*/
	function display_attachment_bodies()
	{
		...
		$template->assign_vars(array(
			...
			'RULES' => '<a href="#" onClick=window.open("' . append_sid($phpbb_root_path . "attach_rules.$phpEx?" . POST_FORUM_URL . "=$u_rules_id") . '","gesamt","location=no,menubar=no,toolbar=no,scrollbars=auto,width=320,height=500,status=no",title="Skype")>' . $lang['Allowed_extensions_and_sizes'] . '</a>',
