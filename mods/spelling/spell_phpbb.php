...
// 		include($phpbb_root_path.$PathPrefix.'mainfile.php');
    ...
    if( !$userdata['session_logged_in'] )
    {
      	...
      	header($header_location . '../' . append_sid('login.'.$phpEx.'?redirect=mods/spelling/spell_admin.'.$phpEx));
      	exit;
    }
...
function DB_Add_Word($Word_To_Add, $Word_Sound)
{
    ...
    $Query = 'INSERT INTO '.$DB_TableName.'(word, sound) 
    	VALUES (\''.$Word_To_Add.'\', \''.$Word_Sound.'\')';
