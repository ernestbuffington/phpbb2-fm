<?php
  ...
  // --------------------------------------------------------------------
  $Language_Character_List = "abcdefghijklmnopqrstuvwxyzàèìòùé'";
  $Language_Common_Words = ",il,lo,la,i,gli,le,è,era,sia,è,era,stato,essendo,è,di,e,un,una,uno,in,dentro,a,abbia,ha,aveva,avendo,lui,egli,suo,esso,suo,io,mio,a,loro,non,no,per,suo,lei,sua,con,su,quello,questi,questo,quelli,faccia,faceva,fa,fatto,facendo,noi,nostro,da,a,ma,da,come,quale,o,dirà,detto,dica,dice,dicendo,ciò,là,se,chi,quindi,vada,andata,andato,va,più,altro,altra,uno,veda,visto,vedendo,sappia,saputo,conosciuto,sa,sapendo,là,"; 
