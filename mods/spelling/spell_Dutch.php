<?php
  ...
  // ---------------------------------------
  // PSPELL Support - Use Dutch Dictionary
  // ---------------------------------------
  ...
  $Language_Common_Words = ",de,is,was,zijn,een,ander,op,in,uit,voor,achter,op,af,hij,zij,heeft,had,was,zal,kan,weet,hier,daar,boven,onder,wij,weten,wist,";
