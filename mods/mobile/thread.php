...
<html>
<head>
<meta name="Copyright" content="phpBB Group &copy; 2002, 2004">
<title><?php echo $CFG['mobile_title']; ?> :: <?php echo $posts[0]['forum_name']; ?> - <?php echo $posts[0]['topic_title']; ?></title>
<link rel="stylesheet" href="../../templates/<?php echo $CFG['template_name'] ?>/<?php echo $CFG['template_css'] ?>" type="text/css">
</head>
<body>
