...
*
* @package content
* @version $Id: bars.php,v 4.2.8 2003/02/06 01:02:59 acydburn Exp $
...
class Content_bars
{
	...
	function init_bars($bars = '')
	{
		...
		$this->current_template_path = 'templates/' . (( $row['image_cfg'] ) ? $row['template_name'] . '/images/' . $row['image_cfg'] : $row['template_name'] . '/images');
