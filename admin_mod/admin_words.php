 ...
 *
* @package admin_mod
* @version $Id: admin_words.php,v 1.10.2.2 2002/05/12 15:57:45 psotfx Exp $
...
if( !empty($setmodules) )
{
	...
	$module['Forums']['Word_Censor'] = $file;
	return;
}
...
if ($cancel)
{
	redirect('admin_mod/' . append_sid("admin_words.$phpEx", true));
}


// Module Activation
if ($board_config['enable_module_words'])
{
