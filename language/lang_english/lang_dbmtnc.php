...
$lang['DB_Maintenance_Description'] = 'Here you can check your database for inconsistencies and errors. Some operations will take longer to perform than others. The board will be <b>disabled</b> during the operations. It is always recommended to %sbackup your database%s before using any of the functions listed below.';

$lang['Incomplete_configuration'] = 'A setting for <b>%s</b> was not found in the board configuration. Maintenance cannot run without this setting.<br />You maybe forgot to execute the SQL statements as described in the installation instructions.';
...
$lang['Back_to_DB_Maintenance'] = 'Return to Database Maintenance';
$lang['Processing_time'] = 'Maintenance took %f seconds for the operations';

$lang['Lock_db'] = 'Disabling board';
$lang['Unlock_db'] = 'Enabling board';
$lang['Already_locked'] = 'Board was already disabled';
$lang['Ignore_unlock_command'] = 'Board was disabled when starting this command. Board will not be enabled';
...
$lang['Nothing_to_do'] = "<p class=\"gen\"><i>No changes.</i></p>\n";
...
$mtnc[] = array('config',
	'Configuration',
	'Allows the configuration of Maintenance.',
	'',
	5);
$mtnc[] = array('--', '', '', '', 0);
...
// config
$lang['Config_info'] = 'The following options allow you to configure the behavior of board maintenance. Please keep in mind that a misconfiguration may lead to unexpected results.';
$lang['General_Config'] = 'General configuration';
$lang['Rebuild_Config'] = 'Rebuild Search Index Settings';
$lang['Current_Rebuild_Config'] = 'Configuration of current rebuilding';
$lang['Rebuild_Settings_Explain'] = 'These settings adjust the behavior when rebuilding the search index.';
$lang['Current_Rebuild_Settings_Explain'] = 'These settings are used to store the position of the current rebuild. There is no need to adapt these settings under normal conditions.';
...
$lang['Rebuildcfg_PHP3Only_Explain'] = 'Maintenance uses an advanced method for indexing when PHP 4.0.5 or newer is available. You can switch off the advanced method so that Maintenance will make use of the standard method of the board.';
...
$lang['Checking_posts_wo_text'] = 'Checking for posts without text';
...
$lang['Speed_up_posts'] = 'Optimizing post text table';
$lang['Speed_up_users'] = 'Optimizing user table';
...
$lang['Checking_pms_wo_text'] = 'Checking for private messages without text';
...
$lang['Restoring_session'] = 'Restoring session of active ADMIN';
// check_db
...
$lang['cbl_success_anonymous'] = 'The ban list and the disallowed users were cleared successful. The anonymous account has been recreated. Since group data of the anonymous account may be missing, it is recommended to use the function &quot;Check user and group tables&quot; in the main part of Maintenance.';
...
// check_topicviews
$lang['Checking_topicview_tables'] = 'Checking topic view tables';
$lang['Checking_invalid_topic_view'] = 'Checking topic view table for invalid viewers';
$lang['Checking_invalid_topic_viewdata'] = 'Checking topic viewdata table for invalid viewers';
