...
* @version $Id: lang_admin_statistics.php,v 4.2.8 2003/02/06 21:27:39 acydburn Exp $
...
$lang['Module_installed'] = 'Module Installed Successfully.';
$lang['Module_updated'] = 'Module Updated Successfully.';
...
$lang['No_modules'] = 'No installed modules found.';
$lang['Click_install_module'] = 'Click %sHere%s to add a module';
...
// Configuration
$lang['Msg_config_updated'] = 'Statistics Configuration Updated Successfully.';
$lang['Msg_reset_view_count'] = 'View Count Reset Successfully.';
$lang['Msg_reset_install_date'] = 'Install Date Reset Successfully.';
$lang['Msg_reset_cache'] = 'All Caches Cleared Successfully.';
$lang['Msg_purge_modules'] = 'Modules Directory Content Deleted Successfully.';
$lang['Stat_index'] = 'Display statistics module on index';
$lang['Stat_index_explain'] = 'Here you can define one module id which will be displayed on the forum index or zero to disable.';
$lang['Stat_all_or_one'] = 'Display one or all modules';
$lang['Stat_all_or_one_explain'] = 'Here you can define one module id which will then be displayed in the Statistics page. Enter zero to display all modules. If you use this, it\'s recommended to put the id for the Statistics Overview module here. When using Statistics Overview module for this option, that module will always be displayed along with the module which you click on in Statistics Overview.';
...
$lang['Update_time_explain'] = 'Time intervall (in minutes) of refreshing the cached data with new data. Every x minutes the module gets reloaded.<br />Since the statistics is using an priority system, this could be greater than x minutes, but not more than one day.';
...
$lang['Click_return_manage_modules'] = 'Click %sHere%s to manage modules';
...
$lang['Language_cp_explain'] = 'Here you are able to manage all language variables and language packs for every eodule, seperate, at all... nearly everything. You are able to import or export language packs here too.';
...
$lang['Import_new_language_explain'] = 'Here you are able to upload (or select) the language pack you want to install. After you have uploaded (or selected) the language pack, you will see some information about the Language Pack. Only after viewing this information will the pack be installed.';
