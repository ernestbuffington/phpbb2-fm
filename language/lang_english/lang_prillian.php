...
* @version $Id: lang_prillian.php,v 0.7.0 2003/01/31 00:31:19 psotfx Exp $
...
$lang['Set_window_sizes_explain'] = 'All sizes are in Pixels. (Width x Height)';
...
$lang['Admin_Set_window_sizes'] = 'Default Window Size Settings';
...
$lang['Size'] = 'Size';
$lang['Color'] = 'Color';
$lang['Enabled_explain'] = 'If set to No, your users will not be allowed to interact with this site.';
...
$lang['Network_autodetect_explain'] = 'Enter the URL of a forum below, and Prillian will attempt to connect to a Prillian installation on the forum at that URL. If the connection is established, Prillian will try to automatically add that site to your Network list. When entering the URL, ensure that it begins with either http:// or ftp:// and ends in a slash. No files names should be included.<br /><br />This is correct: <b>http://www.yourdomain.com/phpbb2/</b><br /><br />These are not correct:<br />www.yourdomain.com/phpbb2/<br />http://www.yourdomain.com/<br />www.yourdomain.com/phpbb2<br />http://www.yourdomain.com/phpbb2/imclient.php<br />http://www.yourdomain.com/phpbb2/mb/imclient.php/';
